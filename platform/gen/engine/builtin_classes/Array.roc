...
Array := {
    ...
    #slice! : I32, I32, I32, GodotRoc.Bool -> Array
    ...
    # any! = |method|
    #any! : Callable -> GodotRoc.Bool
    #any! = Host.any_4129521963!
    # all! = |method|
    #all! : Callable -> GodotRoc.Bool
    ...
    # is_same_typed! = |array|
    #is_same_typed! : Array -> GodotRoc.Bool
