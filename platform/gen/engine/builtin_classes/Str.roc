...
Str := {
    ...
    #contruct_from_String! : String -> String
    #contruct_from! = || { "" }
    #contruct_from_StringName! : StringName -> String
    #contruct_from! = || { "" }
    #contruct_from_NodePath! : NodePath -> String
    #contruct_from! = || { "" }
    ...
    #split! : Str, GodotRoc.Bool, I32 -> PackedStringArray
    #split! = Host.split_1252735785!
    # rsplit! = |delimiter, allow_empty, maxsplit|
    #rsplit! : Str, GodotRoc.Bool, I32 -> PackedStringArray
    #rsplit! = Host.rsplit_1252735785!
    # split_floats! = |delimiter, allow_empty|
    #split_floats! : Str, GodotRoc.Bool -> PackedFloat64Array
    ...
    #strip_edges! : GodotRoc.Bool, GodotRoc.Bool -> Str
