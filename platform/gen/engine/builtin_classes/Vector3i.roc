# builtin_class Vector3i → Vector3i
Vector3i := {
    x : I32,
    y : I32,
    z : I32
    ...
    #construct_from_Vector3i! : Vector3i -> Vector3i
    #construct_from_Vector3i! = |from| { /* TODO host call */ }
    #construct_from_Vector3! : Vector3 -> Vector3i
    #construct_from_Vector3! = |from| { /* TODO host call */ }
    #construct_x_int_y_int_z_int! : I32, I32, I32 -> Vector3i
    #construct_x_int_y_int_z_int! = |x, y, z| { /* TODO host call */ }
    ...
    # name: "*"
    # op_* : Vector3i, I32 -> Vector3i
    # name: "/"
    # op_/ : Vector3i, I32 -> Vector3i
    # name: "%"
    # op_% : Vector3i, I32 -> Vector3i
    # name: "*"
    # op_* : Vector3i, F32 -> Vector3
    # name: "/"
    # op_/ : Vector3i, F32 -> Vector3
    # name: "=="
