# engine class MultiplayerPeerExtension → MultiplayerPeerExtension
# api_type: core
...
MultiplayerPeerExtension := {
    ...
    # _disconnect_peer!  is_const=False is_static=False is_vararg=False
