# engine class NavigationRegion3D → NavigationRegion3D
# api_type: core
...
NavigationRegion3D := {
    ...
    # set_navigation_mesh!  is_const=False is_static=False is_vararg=False
    #set_navigation_mesh! : NavigationMesh -> {}
    #set_navigation_mesh! = Host.set_navigation_mesh_2923361153!
    # get_navigation_mesh!  is_const=True is_static=False is_vararg=False
    #get_navigation_mesh! : () -> NavigationMesh
    #get_navigation_mesh! = Host.get_navigation_mesh_1468720886!
    ...
    # bake_navigation_mesh!  is_const=False is_static=False is_vararg=False
    #bake_navigation_mesh! : Bool -> {}
    #bake_navigation_mesh! = Host.bake_navigation_mesh_3216645846!
