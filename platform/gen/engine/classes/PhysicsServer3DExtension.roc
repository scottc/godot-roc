# engine class PhysicsServer3DExtension → PhysicsServer3DExtension
# api_type: core
...
PhysicsServer3DExtension := {
    ...
    # _body_is_continuous_collision_detection_enabled!  is_const=True is_static=False is_vararg=False
    ...
    # _body_set_max_contacts_reported!  is_const=False is_static=False is_vararg=False
    #_body_set_max_contacts_reported! : RID, I32 -> {}
    #_body_set_max_contacts_reported! = Host._body_set_max_contacts_reported_3411492887!
    # _body_get_max_contacts_reported!  is_const=True is_static=False is_vararg=False
    #_body_get_max_contacts_reported! : RID -> I32
    #_body_get_max_contacts_reported! = Host._body_get_max_contacts_reported_2198884583!
    # _body_set_contacts_reported_depth_threshold!  is_const=False is_static=False is_vararg=False
    ...
    # _body_get_contacts_reported_depth_threshold!  is_const=True is_static=False is_vararg=False
    ...
    # _body_set_omit_force_integration!  is_const=False is_static=False is_vararg=False
    ...
    # _body_is_omitting_force_integration!  is_const=True is_static=False is_vararg=False
    ...
    # _body_set_state_sync_callback!  is_const=False is_static=False is_vararg=False
    #_body_set_state_sync_callback! : RID, Callable -> {}
    #_body_set_state_sync_callback! = Host._body_set_state_sync_callback_3379118538!
    # _body_set_force_integration_callback!  is_const=False is_static=False is_vararg=False
    ...
    # _body_set_ray_pickable!  is_const=False is_static=False is_vararg=False
    #_body_set_ray_pickable! : RID, Bool -> {}
    #_body_set_ray_pickable! = Host._body_set_ray_pickable_1265174801!
    # _body_test_motion!  is_const=True is_static=False is_vararg=False
    ...
    # _body_get_direct_state!  is_const=False is_static=False is_vararg=False
    #_body_get_direct_state! : RID -> PhysicsDirectBodyState3D
    #_body_get_direct_state! = Host._body_get_direct_state_3029727957!
    # _soft_body_create!  is_const=False is_static=False is_vararg=False
    #_soft_body_create! : () -> RID
    #_soft_body_create! = Host._soft_body_create_529393457!
    # _soft_body_update_rendering_server!  is_const=False is_static=False is_vararg=False
    ...
    # _soft_body_remove_collision_exception!  is_const=False is_static=False is_vararg=False
    ...
    # _soft_body_get_collision_exceptions!  is_const=True is_static=False is_vararg=False
    ...
    # _soft_body_get_simulation_precision!  is_const=True is_static=False is_vararg=False
    ...
    # _soft_body_get_pressure_coefficient!  is_const=True is_static=False is_vararg=False
    ...
    # _soft_body_set_damping_coefficient!  is_const=False is_static=False is_vararg=False
    ...
    # _soft_body_get_damping_coefficient!  is_const=True is_static=False is_vararg=False
    ...
    # _soft_body_remove_all_pinned_points!  is_const=False is_static=False is_vararg=False
    ...
    # _soft_body_pin_point!  is_const=False is_static=False is_vararg=False
    #_soft_body_pin_point! : RID, I32, Bool -> {}
    #_soft_body_pin_point! = Host._soft_body_pin_point_2658558584!
    # _soft_body_is_point_pinned!  is_const=True is_static=False is_vararg=False
    #_soft_body_is_point_pinned! : RID, I32 -> Bool
    #_soft_body_is_point_pinned! = Host._soft_body_is_point_pinned_3120086654!
    # _soft_body_apply_point_impulse!  is_const=False is_static=False is_vararg=False
    ...
    # _soft_body_apply_point_force!  is_const=False is_static=False is_vararg=False
    #_soft_body_apply_point_force! : RID, I32, Vector3 -> {}
    #_soft_body_apply_point_force! = Host._soft_body_apply_point_force_831953689!
    # _soft_body_apply_central_impulse!  is_const=False is_static=False is_vararg=False
    ...
    # _hinge_joint_set_param!  is_const=False is_static=False is_vararg=False
    ...
    # _hinge_joint_get_param!  is_const=True is_static=False is_vararg=False
    ...
    # _hinge_joint_set_flag!  is_const=False is_static=False is_vararg=False
    ...
    # _hinge_joint_get_flag!  is_const=True is_static=False is_vararg=False
    ...
    # _joint_make_slider!  is_const=False is_static=False is_vararg=False
    #_joint_make_slider! : RID, RID, Transform3D, RID, Transform3D -> {}
    #_joint_make_slider! = Host._joint_make_slider_1684107643!
    # _slider_joint_set_param!  is_const=False is_static=False is_vararg=False
    ...
    # _slider_joint_get_param!  is_const=True is_static=False is_vararg=False
    ...
    # _joint_make_cone_twist!  is_const=False is_static=False is_vararg=False
    #_joint_make_cone_twist! : RID, RID, Transform3D, RID, Transform3D -> {}
    #_joint_make_cone_twist! = Host._joint_make_cone_twist_1684107643!
    # _cone_twist_joint_set_param!  is_const=False is_static=False is_vararg=False
    ...
    # _cone_twist_joint_get_param!  is_const=True is_static=False is_vararg=False
    ...
    # _joint_make_generic_6dof!  is_const=False is_static=False is_vararg=False
    ...
    # _generic_6dof_joint_set_param!  is_const=False is_static=False is_vararg=False
    ...
    # _generic_6dof_joint_get_param!  is_const=True is_static=False is_vararg=False
    ...
    # _generic_6dof_joint_set_flag!  is_const=False is_static=False is_vararg=False
    ...
    # _generic_6dof_joint_get_flag!  is_const=True is_static=False is_vararg=False
    ...
    # _joint_is_disabled_collisions_between_bodies!  is_const=True is_static=False is_vararg=False
    ...
    # body_test_motion_is_excluding_object!  is_const=True is_static=False is_vararg=False
