# engine class TileSetAtlasSource → TileSetAtlasSource
# api_type: core
...
TileSetAtlasSource := {
    ...
    # get_tile_animation_separation!  is_const=True is_static=False is_vararg=False
    ...
    # set_tile_animation_speed!  is_const=False is_static=False is_vararg=False
    #set_tile_animation_speed! : Vector2i, F32 -> {}
    #set_tile_animation_speed! = Host.set_tile_animation_speed_2262553149!
    # get_tile_animation_speed!  is_const=True is_static=False is_vararg=False
    #get_tile_animation_speed! : Vector2i -> F32
    #get_tile_animation_speed! = Host.get_tile_animation_speed_719993801!
    # set_tile_animation_mode!  is_const=False is_static=False is_vararg=False
    ...
    # get_tile_animation_mode!  is_const=True is_static=False is_vararg=False
    ...
    # set_tile_animation_frames_count!  is_const=False is_static=False is_vararg=False
    ...
    # get_tile_animation_frames_count!  is_const=True is_static=False is_vararg=False
    ...
    # set_tile_animation_frame_duration!  is_const=False is_static=False is_vararg=False
    ...
    # get_tile_animation_frame_duration!  is_const=True is_static=False is_vararg=False
    ...
    # get_tile_animation_total_duration!  is_const=True is_static=False is_vararg=False
