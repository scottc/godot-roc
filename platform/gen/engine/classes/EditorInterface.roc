# engine class EditorInterface → EditorInterface
# api_type: editor
...
EditorInterface := {
    ...
    # --- methods ---
    # restart_editor!  is_const=False is_static=False is_vararg=False
    #restart_editor! : Bool -> {}
    #restart_editor! = Host.restart_editor_3216645846!
    # get_command_palette!  is_const=True is_static=False is_vararg=False
    #get_command_palette! : () -> EditorCommandPalette
    #get_command_palette! = Host.get_command_palette_2471163807!
    # get_resource_filesystem!  is_const=True is_static=False is_vararg=False
    #get_resource_filesystem! : () -> EditorFileSystem
    #get_resource_filesystem! = Host.get_resource_filesystem_780151678!
    # get_editor_paths!  is_const=True is_static=False is_vararg=False
    #get_editor_paths! : () -> EditorPaths
    #get_editor_paths! = Host.get_editor_paths_1595760068!
    # get_resource_previewer!  is_const=True is_static=False is_vararg=False
    ...
    # get_file_system_dock!  is_const=True is_static=False is_vararg=False
    #get_file_system_dock! : () -> FileSystemDock
    #get_file_system_dock! = Host.get_file_system_dock_3751012327!
    # select_file!  is_const=False is_static=False is_vararg=False
    #select_file! : String -> {}
    #select_file! = Host.select_file_83702148!
    # get_selected_paths!  is_const=True is_static=False is_vararg=False
    ...
    # save_scene!  is_const=False is_static=False is_vararg=False
    #save_scene! : () -> enum::Error
    #save_scene! = Host.save_scene_166280745!
    # save_scene_as!  is_const=False is_static=False is_vararg=False
    #save_scene_as! : String, Bool -> {}
    #save_scene_as! = Host.save_scene_as_3647332257!
    # save_all_scenes!  is_const=False is_static=False is_vararg=False
    #save_all_scenes! : () -> {}
    #save_all_scenes! = Host.save_all_scenes_3218959716!
    # close_scene!  is_const=False is_static=False is_vararg=False
    #close_scene! : () -> enum::Error
    #close_scene! = Host.close_scene_166280745!
    # mark_scene_as_unsaved!  is_const=False is_static=False is_vararg=False
    #mark_scene_as_unsaved! : () -> {}
    #mark_scene_as_unsaved! = Host.mark_scene_as_unsaved_3218959716!
    # play_main_scene!  is_const=False is_static=False is_vararg=False
    #play_main_scene! : () -> {}
    #play_main_scene! = Host.play_main_scene_3218959716!
    # play_current_scene!  is_const=False is_static=False is_vararg=False
    #play_current_scene! : () -> {}
    #play_current_scene! = Host.play_current_scene_3218959716!
    # play_custom_scene!  is_const=False is_static=False is_vararg=False
    #play_custom_scene! : String -> {}
    #play_custom_scene! = Host.play_custom_scene_83702148!
    # stop_playing_scene!  is_const=False is_static=False is_vararg=False
    #stop_playing_scene! : () -> {}
    #stop_playing_scene! = Host.stop_playing_scene_3218959716!
    # is_playing_scene!  is_const=True is_static=False is_vararg=False
    #is_playing_scene! : () -> Bool
    #is_playing_scene! = Host.is_playing_scene_36873697!
    # get_playing_scene!  is_const=True is_static=False is_vararg=False
    #get_playing_scene! : () -> String
    #get_playing_scene! = Host.get_playing_scene_201670096!
    # set_movie_maker_enabled!  is_const=False is_static=False is_vararg=False
    #set_movie_maker_enabled! : Bool -> {}
    #set_movie_maker_enabled! = Host.set_movie_maker_enabled_2586408642!
    # is_movie_maker_enabled!  is_const=True is_static=False is_vararg=False
