# engine class AudioStreamInteractive → AudioStreamInteractive
# api_type: core
...
AudioStreamInteractive := {
    ...
    # --- methods ---
    # set_clip_count!  is_const=False is_static=False is_vararg=False
    #set_clip_count! : I32 -> {}
    #set_clip_count! = Host.set_clip_count_1286410249!
    # get_clip_count!  is_const=True is_static=False is_vararg=False
    #get_clip_count! : () -> I32
    #get_clip_count! = Host.get_clip_count_3905245786!
    # set_initial_clip!  is_const=False is_static=False is_vararg=False
    #set_initial_clip! : I32 -> {}
    #set_initial_clip! = Host.set_initial_clip_1286410249!
    # get_initial_clip!  is_const=True is_static=False is_vararg=False
    #get_initial_clip! : () -> I32
    #get_initial_clip! = Host.get_initial_clip_3905245786!
    # set_clip_name!  is_const=False is_static=False is_vararg=False
    #set_clip_name! : I32, StringName -> {}
    #set_clip_name! = Host.set_clip_name_3780747571!
    # get_clip_name!  is_const=True is_static=False is_vararg=False
    #get_clip_name! : I32 -> StringName
    #get_clip_name! = Host.get_clip_name_659327637!
    # set_clip_stream!  is_const=False is_static=False is_vararg=False
    #set_clip_stream! : I32, AudioStream -> {}
    #set_clip_stream! = Host.set_clip_stream_111075094!
    # get_clip_stream!  is_const=True is_static=False is_vararg=False
    #get_clip_stream! : I32 -> AudioStream
    #get_clip_stream! = Host.get_clip_stream_2739380747!
    # set_clip_auto_advance!  is_const=False is_static=False is_vararg=False
    ...
    # get_clip_auto_advance!  is_const=True is_static=False is_vararg=False
    ...
    # set_clip_auto_advance_next_clip!  is_const=False is_static=False is_vararg=False
    #set_clip_auto_advance_next_clip! : I32, I32 -> {}
    #set_clip_auto_advance_next_clip! = Host.set_clip_auto_advance_next_clip_3937882851!
    # get_clip_auto_advance_next_clip!  is_const=True is_static=False is_vararg=False
    ...
    # erase_transition!  is_const=False is_static=False is_vararg=False
    #erase_transition! : I32, I32 -> {}
    #erase_transition! = Host.erase_transition_3937882851!
    # get_transition_list!  is_const=True is_static=False is_vararg=False
    #get_transition_list! : () -> PackedInt32Array
    #get_transition_list! = Host.get_transition_list_1930428628!
    # get_transition_from_time!  is_const=True is_static=False is_vararg=False
    ...
    # get_transition_to_time!  is_const=True is_static=False is_vararg=False
    ...
    # get_transition_fade_mode!  is_const=True is_static=False is_vararg=False
    ...
    # get_transition_fade_beats!  is_const=True is_static=False is_vararg=False
    #get_transition_fade_beats! : I32, I32 -> F32
    #get_transition_fade_beats! = Host.get_transition_fade_beats_3085491603!
    # is_transition_using_filler_clip!  is_const=True is_static=False is_vararg=False
    ...
    # get_transition_filler_clip!  is_const=True is_static=False is_vararg=False
    #get_transition_filler_clip! : I32, I32 -> I32
    #get_transition_filler_clip! = Host.get_transition_filler_clip_3175239445!
    # is_transition_holding_previous!  is_const=True is_static=False is_vararg=False
