# engine class PhysicsServer2D → PhysicsServer2D
# api_type: core
...
PhysicsServer2D := {
    ...
    # segment_shape_create!  is_const=False is_static=False is_vararg=False
    #segment_shape_create! : () -> RID
    #segment_shape_create! = Host.segment_shape_create_529393457!
    # circle_shape_create!  is_const=False is_static=False is_vararg=False
    #circle_shape_create! : () -> RID
    #circle_shape_create! = Host.circle_shape_create_529393457!
    # rectangle_shape_create!  is_const=False is_static=False is_vararg=False
    ...
    # area_attach_canvas_instance_id!  is_const=False is_static=False is_vararg=False
    #area_attach_canvas_instance_id! : RID, I32 -> {}
    #area_attach_canvas_instance_id! = Host.area_attach_canvas_instance_id_3411492887!
    # area_get_canvas_instance_id!  is_const=True is_static=False is_vararg=False
    ...
    # body_set_shape_as_one_way_collision!  is_const=False is_static=False is_vararg=False
    ...
    # body_attach_canvas_instance_id!  is_const=False is_static=False is_vararg=False
    #body_attach_canvas_instance_id! : RID, I32 -> {}
    #body_attach_canvas_instance_id! = Host.body_attach_canvas_instance_id_3411492887!
    # body_get_canvas_instance_id!  is_const=True is_static=False is_vararg=False
    #body_get_canvas_instance_id! : RID -> I32
    #body_get_canvas_instance_id! = Host.body_get_canvas_instance_id_2198884583!
    # body_set_continuous_collision_detection_mode!  is_const=False is_static=False is_vararg=False
    ...
    # body_get_continuous_collision_detection_mode!  is_const=True is_static=False is_vararg=False
    ...
    # joint_set_param!  is_const=False is_static=False is_vararg=False
    #joint_set_param! : RID, enum::PhysicsServer2D.JointParam, F32 -> {}
    #joint_set_param! = Host.joint_set_param_3972556514!
    # joint_get_param!  is_const=True is_static=False is_vararg=False
    ...
    # damped_spring_joint_set_param!  is_const=False is_static=False is_vararg=False
    ...
    # damped_spring_joint_get_param!  is_const=True is_static=False is_vararg=False
