# engine class GLTFDocumentExtension → GLTFDocumentExtension
# api_type: core
...
GLTFDocumentExtension := {
    ...
    # _get_saveable_image_formats!  is_const=False is_static=False is_vararg=False
    #_get_saveable_image_formats! : () -> PackedStringArray
    #_get_saveable_image_formats! = Host._get_saveable_image_formats_2981934095!
    # _serialize_image_to_bytes!  is_const=False is_static=False is_vararg=False
    ...
    # _save_image_at_path!  is_const=False is_static=False is_vararg=False
    #_save_image_at_path! : GLTFState, Image, String, String, F32 -> enum::Error
    #_save_image_at_path! = Host._save_image_at_path_1844337242!
    # _serialize_texture_json!  is_const=False is_static=False is_vararg=False
    ...
    # _export_node!  is_const=False is_static=False is_vararg=False
    #_export_node! : GLTFState, GLTFNode, Dictionary, Node -> enum::Error
    #_export_node! = Host._export_node_4064279746!
    # _export_post!  is_const=False is_static=False is_vararg=False
