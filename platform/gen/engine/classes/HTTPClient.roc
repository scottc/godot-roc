# engine class HTTPClient → HTTPClient
# api_type: core
...
HTTPClient := {
    ...
    # set_connection!  is_const=False is_static=False is_vararg=False
    #set_connection! : StreamPeer -> {}
    #set_connection! = Host.set_connection_3281897016!
    # get_connection!  is_const=True is_static=False is_vararg=False
    ...
    # has_response!  is_const=True is_static=False is_vararg=False
    #has_response! : () -> Bool
    #has_response! = Host.has_response_36873697!
    # is_response_chunked!  is_const=True is_static=False is_vararg=False
    #is_response_chunked! : () -> Bool
    #is_response_chunked! = Host.is_response_chunked_36873697!
    # get_response_code!  is_const=True is_static=False is_vararg=False
    #get_response_code! : () -> I32
    #get_response_code! = Host.get_response_code_3905245786!
    # get_response_headers!  is_const=False is_static=False is_vararg=False
    #get_response_headers! : () -> PackedStringArray
    #get_response_headers! = Host.get_response_headers_2981934095!
    # get_response_headers_as_dictionary!  is_const=False is_static=False is_vararg=False
    ...
    # query_string_from_dict!  is_const=False is_static=False is_vararg=False
