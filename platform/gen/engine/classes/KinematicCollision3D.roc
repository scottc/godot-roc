# engine class KinematicCollision3D → KinematicCollision3D
# api_type: core
...
KinematicCollision3D := {
    ...
    #get_travel! : () -> Vector3
    #get_travel! = Host.get_travel_3360562783!
    # get_remainder!  is_const=True is_static=False is_vararg=False
    #get_remainder! : () -> Vector3
    #get_remainder! = Host.get_remainder_3360562783!
