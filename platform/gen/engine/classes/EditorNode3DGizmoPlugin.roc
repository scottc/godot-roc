# engine class EditorNode3DGizmoPlugin → EditorNode3DGizmoPlugin
# api_type: editor
...
EditorNode3DGizmoPlugin := {
    ...
    # --- methods ---
    # _has_gizmo!  is_const=True is_static=False is_vararg=False
    #_has_gizmo! : Node3D -> Bool
    #_has_gizmo! = Host._has_gizmo_1905827158!
    # _create_gizmo!  is_const=True is_static=False is_vararg=False
    #_create_gizmo! : Node3D -> EditorNode3DGizmo
    #_create_gizmo! = Host._create_gizmo_1418965287!
    # _get_gizmo_name!  is_const=True is_static=False is_vararg=False
    ...
    # _can_be_hidden!  is_const=True is_static=False is_vararg=False
    #_can_be_hidden! : () -> Bool
    #_can_be_hidden! = Host._can_be_hidden_36873697!
    # _is_selectable_when_hidden!  is_const=True is_static=False is_vararg=False
    #_is_selectable_when_hidden! : () -> Bool
    #_is_selectable_when_hidden! = Host._is_selectable_when_hidden_36873697!
    # _can_commit_handle_on_click!  is_const=True is_static=False is_vararg=False
