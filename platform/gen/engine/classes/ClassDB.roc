...
ClassDB := {
    ...
    # --- methods ---
    # get_class_list!  is_const=True is_static=False is_vararg=False
    #get_class_list! : () -> PackedStringArray
    #get_class_list! = Host.get_class_list_1139954409!
    # get_inheriters_from_class!  is_const=True is_static=False is_vararg=False
    ...
    # get_parent_class!  is_const=True is_static=False is_vararg=False
    #get_parent_class! : StringName -> StringName
    #get_parent_class! = Host.get_parent_class_1965194235!
    # class_exists!  is_const=True is_static=False is_vararg=False
    #class_exists! : StringName -> Bool
    #class_exists! = Host.class_exists_2619796661!
    # is_parent_class!  is_const=True is_static=False is_vararg=False
    ...
    # class_get_property_getter!  is_const=False is_static=False is_vararg=False
    ...
    # class_get_property_setter!  is_const=False is_static=False is_vararg=False
    ...
    # class_get_property!  is_const=True is_static=False is_vararg=False
    #class_get_property! : Object, StringName -> Variant
    #class_get_property! = Host.class_get_property_2498641674!
    # class_set_property!  is_const=True is_static=False is_vararg=False
    #class_set_property! : Object, StringName, Variant -> enum::Error
    #class_set_property! = Host.class_set_property_1690314931!
    # class_get_property_default_value!  is_const=True is_static=False is_vararg=False
    ...
    # class_has_method!  is_const=True is_static=False is_vararg=False
    #class_has_method! : StringName, StringName, Bool -> Bool
    #class_has_method! = Host.class_has_method_3860701026!
    # class_get_method_argument_count!  is_const=True is_static=False is_vararg=False
    ...
    # class_has_integer_constant!  is_const=True is_static=False is_vararg=False
    ...
    # class_get_integer_constant!  is_const=True is_static=False is_vararg=False
    ...
    # class_get_integer_constant_enum!  is_const=True is_static=False is_vararg=False
    ...
    # is_class_enum_bitfield!  is_const=True is_static=False is_vararg=False
    #is_class_enum_bitfield! : StringName, StringName, Bool -> Bool
    #is_class_enum_bitfield! = Host.is_class_enum_bitfield_3860701026!
    # is_class_enabled!  is_const=True is_static=False is_vararg=False
