...
Curve3D := {
    ...
    # set_point_tilt!  is_const=False is_static=False is_vararg=False
    #set_point_tilt! : I32, F32 -> {}
    #set_point_tilt! = Host.set_point_tilt_1602489585!
    # get_point_tilt!  is_const=True is_static=False is_vararg=False
    ...
    # set_up_vector_enabled!  is_const=False is_static=False is_vararg=False
    #set_up_vector_enabled! : Bool -> {}
    #set_up_vector_enabled! = Host.set_up_vector_enabled_2586408642!
    # is_up_vector_enabled!  is_const=True is_static=False is_vararg=False
    ...
    # sample_baked_up_vector!  is_const=True is_static=False is_vararg=False
    ...
    # get_baked_tilts!  is_const=True is_static=False is_vararg=False
    #get_baked_tilts! : () -> PackedFloat32Array
    #get_baked_tilts! = Host.get_baked_tilts_675695659!
    # get_baked_up_vectors!  is_const=True is_static=False is_vararg=False
