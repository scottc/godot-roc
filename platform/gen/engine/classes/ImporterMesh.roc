# engine class ImporterMesh → ImporterMesh
# api_type: core
...
ImporterMesh := {
    ...
    # --- methods ---
    # merge_importer_meshes!  is_const=False is_static=True is_vararg=False
    ...
    # add_surface!  is_const=False is_static=False is_vararg=False
    ...
    # get_surface_primitive_type!  is_const=False is_static=False is_vararg=False
    ...
    # get_surface_name!  is_const=True is_static=False is_vararg=False
    #get_surface_name! : I32 -> String
    #get_surface_name! = Host.get_surface_name_844755477!
    # get_surface_arrays!  is_const=True is_static=False is_vararg=False
    #get_surface_arrays! : I32 -> Array
    #get_surface_arrays! = Host.get_surface_arrays_663333327!
    # get_surface_blend_shape_arrays!  is_const=True is_static=False is_vararg=False
    ...
    # from_mesh!  is_const=False is_static=True is_vararg=False
