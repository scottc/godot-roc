# engine class OpenXRInterface → OpenXRInterface
# api_type: core
...
OpenXRInterface := {
    ...
    HandJointFlags : [HAND_JOINT_NONE, HAND_JOINT_ORIENTATION_VALID, HAND_JOINT_ORIENTATION_TRACKED, HAND_JOINT_POSITION_VALID, HAND_JOINT_POSITION_TRACKED, HAND_JOINT_LINEAR_VELOCITY_VALID, HAND_JOINT_ANGULAR_VELOCITY_VALID]  # bitfield
    ...
    # set_foveation_with_subsampled_images!  is_const=False is_static=False is_vararg=False
    ...
    # is_action_set_active!  is_const=True is_static=False is_vararg=False
    #is_action_set_active! : String -> Bool
    #is_action_set_active! = Host.is_action_set_active_3927539163!
    # set_action_set_active!  is_const=False is_static=False is_vararg=False
    ...
    # get_hand_joint_rotation!  is_const=True is_static=False is_vararg=False
    ...
    # get_hand_joint_position!  is_const=True is_static=False is_vararg=False
    ...
    # is_hand_tracking_supported!  is_const=False is_static=False is_vararg=False
    #is_hand_tracking_supported! : () -> Bool
    #is_hand_tracking_supported! = Host.is_hand_tracking_supported_2240911060!
    # is_hand_interaction_supported!  is_const=True is_static=False is_vararg=False
    #is_hand_interaction_supported! : () -> Bool
    #is_hand_interaction_supported! = Host.is_hand_interaction_supported_36873697!
    # is_eye_gaze_interaction_supported!  is_const=False is_static=False is_vararg=False
    ...
    # set_cpu_level!  is_const=False is_static=False is_vararg=False
    #set_cpu_level! : enum::OpenXRInterface.PerfSettingsLevel -> {}
    #set_cpu_level! = Host.set_cpu_level_2940842095!
    # set_gpu_level!  is_const=False is_static=False is_vararg=False
