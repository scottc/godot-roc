...
TileSet := {
    ...
    # --- methods ---
    # get_next_source_id!  is_const=True is_static=False is_vararg=False
    #get_next_source_id! : () -> I32
    #get_next_source_id! = Host.get_next_source_id_3905245786!
    # add_source!  is_const=False is_static=False is_vararg=False
    #add_source! : TileSetSource, I32 -> I32
    #add_source! = Host.add_source_1059186179!
    # remove_source!  is_const=False is_static=False is_vararg=False
    #remove_source! : I32 -> {}
    #remove_source! = Host.remove_source_1286410249!
    # set_source_id!  is_const=False is_static=False is_vararg=False
    #set_source_id! : I32, I32 -> {}
    #set_source_id! = Host.set_source_id_3937882851!
    # get_source_count!  is_const=True is_static=False is_vararg=False
    #get_source_count! : () -> I32
    #get_source_count! = Host.get_source_count_3905245786!
    # get_source_id!  is_const=True is_static=False is_vararg=False
    #get_source_id! : I32 -> I32
    #get_source_id! = Host.get_source_id_923996154!
    # has_source!  is_const=True is_static=False is_vararg=False
    #has_source! : I32 -> Bool
    ...
    # get_occlusion_layer_sdf_collision!  is_const=True is_static=False is_vararg=False
    ...
    # get_physics_layers_count!  is_const=True is_static=False is_vararg=False
    #get_physics_layers_count! : () -> I32
    #get_physics_layers_count! = Host.get_physics_layers_count_3905245786!
    # add_physics_layer!  is_const=False is_static=False is_vararg=False
    #add_physics_layer! : I32 -> {}
    #add_physics_layer! = Host.add_physics_layer_1025054187!
    # move_physics_layer!  is_const=False is_static=False is_vararg=False
    #move_physics_layer! : I32, I32 -> {}
    #move_physics_layer! = Host.move_physics_layer_3937882851!
    # remove_physics_layer!  is_const=False is_static=False is_vararg=False
    #remove_physics_layer! : I32 -> {}
    #remove_physics_layer! = Host.remove_physics_layer_1286410249!
    # set_physics_layer_collision_layer!  is_const=False is_static=False is_vararg=False
    ...
    # get_physics_layer_collision_layer!  is_const=True is_static=False is_vararg=False
    ...
    # set_physics_layer_collision_mask!  is_const=False is_static=False is_vararg=False
    ...
    # get_physics_layer_collision_mask!  is_const=True is_static=False is_vararg=False
    #get_physics_layer_collision_mask! : I32 -> I32
    #get_physics_layer_collision_mask! = Host.get_physics_layer_collision_mask_923996154!
    # set_physics_layer_collision_priority!  is_const=False is_static=False is_vararg=False
    ...
    # get_physics_layer_collision_priority!  is_const=True is_static=False is_vararg=False
    ...
    # set_physics_layer_physics_material!  is_const=False is_static=False is_vararg=False
    ...
    # get_physics_layer_physics_material!  is_const=True is_static=False is_vararg=False
    ...
    # get_navigation_layer_layer_value!  is_const=True is_static=False is_vararg=False
    ...
    # get_alternative_level_tile_proxy!  is_const=False is_static=False is_vararg=False
    ...
    # has_alternative_level_tile_proxy!  is_const=False is_static=False is_vararg=False
    ...
    # remove_alternative_level_tile_proxy!  is_const=False is_static=False is_vararg=False
    ...
    # map_tile_proxy!  is_const=True is_static=False is_vararg=False
    #map_tile_proxy! : I32, Vector2i, I32 -> Array
    #map_tile_proxy! = Host.map_tile_proxy_4267935328!
    # cleanup_invalid_tile_proxies!  is_const=False is_static=False is_vararg=False
    #cleanup_invalid_tile_proxies! : () -> {}
    #cleanup_invalid_tile_proxies! = Host.cleanup_invalid_tile_proxies_3218959716!
    # clear_tile_proxies!  is_const=False is_static=False is_vararg=False
    #clear_tile_proxies! : () -> {}
    #clear_tile_proxies! = Host.clear_tile_proxies_3218959716!
    # add_pattern!  is_const=False is_static=False is_vararg=False
    #add_pattern! : TileMapPattern, I32 -> I32
    #add_pattern! = Host.add_pattern_763712015!
    # get_pattern!  is_const=False is_static=False is_vararg=False
    #get_pattern! : I32 -> TileMapPattern
    #get_pattern! = Host.get_pattern_4207737510!
    # remove_pattern!  is_const=False is_static=False is_vararg=False
    #remove_pattern! : I32 -> {}
    #remove_pattern! = Host.remove_pattern_1286410249!
    # get_patterns_count!  is_const=False is_static=False is_vararg=False
