# engine class TreeItem → TreeItem
# api_type: core
...
TreeItem := {
    ...
    # --- methods ---
    # set_cell_mode!  is_const=False is_static=False is_vararg=False
    #set_cell_mode! : I32, enum::TreeItem.TreeCellMode -> {}
    #set_cell_mode! = Host.set_cell_mode_289920701!
    # get_cell_mode!  is_const=True is_static=False is_vararg=False
    ...
    # set_edit_multiline!  is_const=False is_static=False is_vararg=False
    #set_edit_multiline! : I32, Bool -> {}
    #set_edit_multiline! = Host.set_edit_multiline_300928843!
    # is_edit_multiline!  is_const=True is_static=False is_vararg=False
    ...
    # propagate_check!  is_const=False is_static=False is_vararg=False
    ...
    # is_collapsed!  is_const=False is_static=False is_vararg=False
    #is_collapsed! : () -> Bool
    #is_collapsed! = Host.is_collapsed_2240911060!
    # set_collapsed_recursive!  is_const=False is_static=False is_vararg=False
    #set_collapsed_recursive! : Bool -> {}
    #set_collapsed_recursive! = Host.set_collapsed_recursive_2586408642!
    # is_any_collapsed!  is_const=False is_static=False is_vararg=False
    ...
    # uncollapse_tree!  is_const=False is_static=False is_vararg=False
    #uncollapse_tree! : () -> {}
    #uncollapse_tree! = Host.uncollapse_tree_3218959716!
    # set_custom_minimum_height!  is_const=False is_static=False is_vararg=False
    #set_custom_minimum_height! : I32 -> {}
    #set_custom_minimum_height! = Host.set_custom_minimum_height_1286410249!
    # get_custom_minimum_height!  is_const=True is_static=False is_vararg=False
    ...
    # get_prev!  is_const=False is_static=False is_vararg=False
    #get_prev! : () -> TreeItem
    ...
    # get_index!  is_const=False is_static=False is_vararg=False
    #get_index! : () -> I32
    #get_index! = Host.get_index_2455072627!
    # move_before!  is_const=False is_static=False is_vararg=False
    #move_before! : TreeItem -> {}
    #move_before! = Host.move_before_1819951137!
    # move_after!  is_const=False is_static=False is_vararg=False
    #move_after! : TreeItem -> {}
    #move_after! = Host.move_after_1819951137!
    # call_recursive!  is_const=False is_static=False is_vararg=True
