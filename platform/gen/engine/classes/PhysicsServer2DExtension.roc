# engine class PhysicsServer2DExtension → PhysicsServer2DExtension
# api_type: core
...
PhysicsServer2DExtension := {
    ...
    # _segment_shape_create!  is_const=False is_static=False is_vararg=False
    #_segment_shape_create! : () -> RID
    #_segment_shape_create! = Host._segment_shape_create_529393457!
    # _circle_shape_create!  is_const=False is_static=False is_vararg=False
    #_circle_shape_create! : () -> RID
    #_circle_shape_create! = Host._circle_shape_create_529393457!
    # _rectangle_shape_create!  is_const=False is_static=False is_vararg=False
    ...
    # _shape_collide!  is_const=False is_static=False is_vararg=False
    ...
    # _area_attach_canvas_instance_id!  is_const=False is_static=False is_vararg=False
    #_area_attach_canvas_instance_id! : RID, I32 -> {}
    #_area_attach_canvas_instance_id! = Host._area_attach_canvas_instance_id_3411492887!
    # _area_get_canvas_instance_id!  is_const=True is_static=False is_vararg=False
    ...
    # _area_set_pickable!  is_const=False is_static=False is_vararg=False
    ...
    # _body_set_shape_as_one_way_collision!  is_const=False is_static=False is_vararg=False
    ...
    # _body_attach_canvas_instance_id!  is_const=False is_static=False is_vararg=False
    #_body_attach_canvas_instance_id! : RID, I32 -> {}
    #_body_attach_canvas_instance_id! = Host._body_attach_canvas_instance_id_3411492887!
    # _body_get_canvas_instance_id!  is_const=True is_static=False is_vararg=False
    #_body_get_canvas_instance_id! : RID -> I32
    #_body_get_canvas_instance_id! = Host._body_get_canvas_instance_id_2198884583!
    # _body_set_continuous_collision_detection_mode!  is_const=False is_static=False is_vararg=False
    ...
    # _body_get_continuous_collision_detection_mode!  is_const=True is_static=False is_vararg=False
    ...
    # _body_collide_shape!  is_const=False is_static=False is_vararg=False
    ...
    # _body_set_pickable!  is_const=False is_static=False is_vararg=False
    ...
    # _joint_set_param!  is_const=False is_static=False is_vararg=False
    #_joint_set_param! : RID, enum::PhysicsServer2D.JointParam, F32 -> {}
    #_joint_set_param! = Host._joint_set_param_3972556514!
    # _joint_get_param!  is_const=True is_static=False is_vararg=False
    ...
    # _damped_spring_joint_set_param!  is_const=False is_static=False is_vararg=False
    ...
    # _damped_spring_joint_get_param!  is_const=True is_static=False is_vararg=False
