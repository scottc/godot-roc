# engine class TileMapLayer → TileMapLayer
# api_type: core
...
TileMapLayer := {
    ...
    # _update_cells!  is_const=False is_static=False is_vararg=False
    ...
    # has_body_rid!  is_const=True is_static=False is_vararg=False
    #has_body_rid! : RID -> Bool
    #has_body_rid! = Host.has_body_rid_4155700596!
    # get_coords_for_body_rid!  is_const=True is_static=False is_vararg=False
    ...
    # set_tile_map_data_from_array!  is_const=False is_static=False is_vararg=False
    #set_tile_map_data_from_array! : PackedByteArray -> {}
    #set_tile_map_data_from_array! = Host.set_tile_map_data_from_array_2971499966!
    # get_tile_map_data_as_array!  is_const=True is_static=False is_vararg=False
    ...
    # set_tile_set!  is_const=False is_static=False is_vararg=False
    #set_tile_set! : TileSet -> {}
    #set_tile_set! = Host.set_tile_set_774531446!
    # get_tile_set!  is_const=True is_static=False is_vararg=False
    ...
    # set_x_draw_order_reversed!  is_const=False is_static=False is_vararg=False
    #set_x_draw_order_reversed! : Bool -> {}
    #set_x_draw_order_reversed! = Host.set_x_draw_order_reversed_2586408642!
    # is_x_draw_order_reversed!  is_const=True is_static=False is_vararg=False
    ...
    # set_collision_enabled!  is_const=False is_static=False is_vararg=False
    #set_collision_enabled! : Bool -> {}
    #set_collision_enabled! = Host.set_collision_enabled_2586408642!
    # is_collision_enabled!  is_const=True is_static=False is_vararg=False
    #is_collision_enabled! : () -> Bool
    #is_collision_enabled! = Host.is_collision_enabled_36873697!
    # set_use_kinematic_bodies!  is_const=False is_static=False is_vararg=False
    #set_use_kinematic_bodies! : Bool -> {}
    #set_use_kinematic_bodies! = Host.set_use_kinematic_bodies_2586408642!
    # is_using_kinematic_bodies!  is_const=True is_static=False is_vararg=False
