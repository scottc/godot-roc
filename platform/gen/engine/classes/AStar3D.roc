...
AStar3D := {
    ...
    #add_point! = Host.add_point_1038703438!
    ...
    #get_closest_point! = Host.get_closest_point_3241074317!
    ...
    #get_closest_position_in_segment! = Host.get_closest_position_in_segment_192990374!
    # get_point_path!  is_const=False is_static=False is_vararg=False
    #get_point_path! : I32, I32, Bool -> PackedVector3Array
    #get_point_path! = Host.get_point_path_1562654675!
