# engine class AccessibilityServer → AccessibilityServer
# api_type: core
...
AccessibilityServer := {
    ...
    # --- methods ---
    # is_supported!  is_const=True is_static=False is_vararg=False
    #is_supported! : () -> Bool
    #is_supported! = Host.is_supported_36873697!
    # create_element!  is_const=False is_static=False is_vararg=False
    #create_element! : I32, enum::AccessibilityServer.AccessibilityRole -> RID
    #create_element! = Host.create_element_3846965249!
    # create_sub_element!  is_const=False is_static=False is_vararg=False
    ...
    # create_sub_text_edit_elements!  is_const=False is_static=False is_vararg=False
