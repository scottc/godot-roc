# engine class EditorExportPlatformExtension → EditorExportPlatformExtension
# api_type: editor
...
EditorExportPlatformExtension := {
    ...
    # --- methods ---
    # _get_preset_features!  is_const=True is_static=False is_vararg=False
    #_get_preset_features! : EditorExportPreset -> PackedStringArray
    #_get_preset_features! = Host._get_preset_features_1387456631!
    # _is_executable!  is_const=True is_static=False is_vararg=False
    ...
    # _should_update_export_options!  is_const=False is_static=False is_vararg=False
    ...
    # _get_os_name!  is_const=True is_static=False is_vararg=False
    #_get_os_name! : () -> String
    ...
    # _get_logo!  is_const=True is_static=False is_vararg=False
    #_get_logo! : () -> Texture2D
    #_get_logo! = Host._get_logo_3635182373!
    # _poll_export!  is_const=False is_static=False is_vararg=False
    #_poll_export! : () -> Bool
    #_poll_export! = Host._poll_export_2240911060!
    # _get_options_count!  is_const=True is_static=False is_vararg=False
    #_get_options_count! : () -> I32
    #_get_options_count! = Host._get_options_count_3905245786!
    # _get_options_tooltip!  is_const=True is_static=False is_vararg=False
    #_get_options_tooltip! : () -> String
    #_get_options_tooltip! = Host._get_options_tooltip_201670096!
    # _get_option_icon!  is_const=True is_static=False is_vararg=False
    #_get_option_icon! : I32 -> Texture2D
    #_get_option_icon! = Host._get_option_icon_3536238170!
    # _get_option_label!  is_const=True is_static=False is_vararg=False
    #_get_option_label! : I32 -> String
    #_get_option_label! = Host._get_option_label_844755477!
    # _get_option_tooltip!  is_const=True is_static=False is_vararg=False
    #_get_option_tooltip! : I32 -> String
    #_get_option_tooltip! = Host._get_option_tooltip_844755477!
    # _get_device_architecture!  is_const=True is_static=False is_vararg=False
    ...
    # _get_run_icon!  is_const=True is_static=False is_vararg=False
    #_get_run_icon! : () -> Texture2D
    #_get_run_icon! = Host._get_run_icon_3635182373!
    # _can_export!  is_const=True is_static=False is_vararg=False
    #_can_export! : EditorExportPreset, Bool -> Bool
    #_can_export! = Host._can_export_493961987!
    # _has_valid_export_configuration!  is_const=True is_static=False is_vararg=False
    ...
    # _has_valid_project_configuration!  is_const=True is_static=False is_vararg=False
    ...
    # _get_binary_extensions!  is_const=True is_static=False is_vararg=False
    #_get_binary_extensions! : EditorExportPreset -> PackedStringArray
    #_get_binary_extensions! = Host._get_binary_extensions_1387456631!
    # _export_project!  is_const=False is_static=False is_vararg=False
    ...
    # _export_pack!  is_const=False is_static=False is_vararg=False
    ...
    # _export_zip!  is_const=False is_static=False is_vararg=False
    ...
    # _export_pack_patch!  is_const=False is_static=False is_vararg=False
    ...
    # _export_zip_patch!  is_const=False is_static=False is_vararg=False
    ...
    # _get_platform_features!  is_const=True is_static=False is_vararg=False
    #_get_platform_features! : () -> PackedStringArray
    #_get_platform_features! = Host._get_platform_features_1139954409!
    # _get_debug_protocol!  is_const=True is_static=False is_vararg=False
    ...
    # set_config_error!  is_const=True is_static=False is_vararg=False
    #set_config_error! : String -> {}
    #set_config_error! = Host.set_config_error_3089850668!
    # get_config_error!  is_const=True is_static=False is_vararg=False
    #get_config_error! : () -> String
    #get_config_error! = Host.get_config_error_201670096!
    # set_config_missing_templates!  is_const=True is_static=False is_vararg=False
    #set_config_missing_templates! : Bool -> {}
    #set_config_missing_templates! = Host.set_config_missing_templates_1695273946!
    # get_config_missing_templates!  is_const=True is_static=False is_vararg=False
