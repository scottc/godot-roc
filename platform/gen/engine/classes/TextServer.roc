# engine class TextServer → TextServer
# api_type: core
...
TextServer := {
    ...
    JustificationFlag : [JUSTIFICATION_NONE, JUSTIFICATION_KASHIDA, JUSTIFICATION_WORD_BOUND, JUSTIFICATION_TRIM_EDGE_SPACES, JUSTIFICATION_AFTER_LAST_TAB, JUSTIFICATION_CONSTRAIN_ELLIPSIS, JUSTIFICATION_SKIP_LAST_LINE, JUSTIFICATION_SKIP_LAST_LINE_WITH_VISIBLE_CHARS, JUSTIFICATION_DO_NOT_SKIP_SINGLE_LINE]  # bitfield
    AutowrapMode : [AUTOWRAP_OFF, AUTOWRAP_ARBITRARY, AUTOWRAP_WORD, AUTOWRAP_WORD_SMART]
    LineBreakFlag : [BREAK_NONE, BREAK_MANDATORY, BREAK_WORD_BOUND, BREAK_GRAPHEME_BOUND, BREAK_ADAPTIVE, BREAK_TRIM_EDGE_SPACES, BREAK_TRIM_INDENT, BREAK_TRIM_START_EDGE_SPACES, BREAK_TRIM_END_EDGE_SPACES]  # bitfield
    ...
    TextOverrunFlag : [OVERRUN_NO_TRIM, OVERRUN_TRIM, OVERRUN_TRIM_WORD_ONLY, OVERRUN_ADD_ELLIPSIS, OVERRUN_ENFORCE_ELLIPSIS, OVERRUN_JUSTIFICATION_AWARE, OVERRUN_SHORT_STRING_ELLIPSIS]  # bitfield
    ...
    FontStyle : [FONT_BOLD, FONT_ITALIC, FONT_FIXED_WIDTH]  # bitfield
    ...
    # font_get_disable_embedded_bitmaps!  is_const=True is_static=False is_vararg=False
    ...
    # font_set_generate_mipmaps!  is_const=False is_static=False is_vararg=False
    #font_set_generate_mipmaps! : RID, Bool -> {}
    #font_set_generate_mipmaps! = Host.font_set_generate_mipmaps_1265174801!
    # font_get_generate_mipmaps!  is_const=True is_static=False is_vararg=False
    #font_get_generate_mipmaps! : RID -> Bool
    #font_get_generate_mipmaps! = Host.font_get_generate_mipmaps_4155700596!
    # font_set_multichannel_signed_distance_field!  is_const=False is_static=False is_vararg=False
    ...
    # font_is_multichannel_signed_distance_field!  is_const=True is_static=False is_vararg=False
    ...
    # font_get_fixed_size_scale_mode!  is_const=True is_static=False is_vararg=False
    ...
    # font_get_palette_custom_colors!  is_const=True is_static=False is_vararg=False
    ...
    # font_get_subpixel_positioning!  is_const=True is_static=False is_vararg=False
    ...
    # font_set_keep_rounding_remainders!  is_const=False is_static=False is_vararg=False
    ...
    # font_get_keep_rounding_remainders!  is_const=True is_static=False is_vararg=False
    ...
    # font_get_variation_coordinates!  is_const=True is_static=False is_vararg=False
    ...
    # font_get_texture_offsets!  is_const=True is_static=False is_vararg=False
    ...
    # font_is_language_supported!  is_const=True is_static=False is_vararg=False
    #font_is_language_supported! : RID, String -> Bool
    #font_is_language_supported! = Host.font_is_language_supported_3199320846!
    # font_set_language_support_override!  is_const=False is_static=False is_vararg=False
    ...
    # font_get_language_support_override!  is_const=False is_static=False is_vararg=False
    ...
    # font_remove_language_support_override!  is_const=False is_static=False is_vararg=False
    ...
    # font_get_language_support_overrides!  is_const=False is_static=False is_vararg=False
    ...
    # font_is_script_supported!  is_const=True is_static=False is_vararg=False
    #font_is_script_supported! : RID, String -> Bool
    #font_is_script_supported! = Host.font_is_script_supported_3199320846!
    # font_set_script_support_override!  is_const=False is_static=False is_vararg=False
    ...
    # font_get_script_support_override!  is_const=False is_static=False is_vararg=False
    ...
    # font_remove_script_support_override!  is_const=False is_static=False is_vararg=False
    ...
    # font_get_script_support_overrides!  is_const=False is_static=False is_vararg=False
    ...
    # font_set_opentype_feature_overrides!  is_const=False is_static=False is_vararg=False
    ...
    # font_get_opentype_feature_overrides!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_clear!  is_const=False is_static=False is_vararg=False
    #shaped_text_clear! : RID -> {}
    #shaped_text_clear! = Host.shaped_text_clear_2722037293!
    # shaped_text_duplicate!  is_const=False is_static=False is_vararg=False
    #shaped_text_duplicate! : RID -> RID
    #shaped_text_duplicate! = Host.shaped_text_duplicate_41030802!
    # shaped_text_set_direction!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_direction!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_inferred_direction!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_set_bidi_override!  is_const=False is_static=False is_vararg=False
    #shaped_text_set_bidi_override! : RID, Array -> {}
    #shaped_text_set_bidi_override! = Host.shaped_text_set_bidi_override_684822712!
    # shaped_text_set_custom_punctuation!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_custom_punctuation!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_orientation!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_set_preserve_invalid!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_preserve_invalid!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_set_preserve_control!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_preserve_control!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_set_spacing!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_spacing!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_add_string!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_add_object!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_resize_object!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_get_span_text!  is_const=True is_static=False is_vararg=False
    #shaped_get_span_text! : RID, I32 -> String
    #shaped_get_span_text! = Host.shaped_get_span_text_1464764419!
    # shaped_get_span_object!  is_const=True is_static=False is_vararg=False
    #shaped_get_span_object! : RID, I32 -> Variant
    #shaped_get_span_object! = Host.shaped_get_span_object_4069510997!
    # shaped_set_span_update_font!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_line_breaks!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_word_breaks!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_trim_pos!  is_const=True is_static=False is_vararg=False
    #shaped_text_get_trim_pos! : RID -> I32
    #shaped_text_get_trim_pos! = Host.shaped_text_get_trim_pos_2198884583!
    # shaped_text_get_ellipsis_pos!  is_const=True is_static=False is_vararg=False
    #shaped_text_get_ellipsis_pos! : RID -> I32
    #shaped_text_get_ellipsis_pos! = Host.shaped_text_get_ellipsis_pos_2198884583!
    # shaped_text_get_ellipsis_glyphs!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_ellipsis_glyph_count!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_overrun_trim_to_width!  is_const=False is_static=False is_vararg=False
    ...
    # shaped_text_get_objects!  is_const=True is_static=False is_vararg=False
    #shaped_text_get_objects! : RID -> Array
    #shaped_text_get_objects! = Host.shaped_text_get_objects_2684255073!
    # shaped_text_get_object_rect!  is_const=True is_static=False is_vararg=False
    #shaped_text_get_object_rect! : RID, Variant -> Rect2
    #shaped_text_get_object_rect! = Host.shaped_text_get_object_rect_447978354!
    # shaped_text_get_object_range!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_underline_thickness!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_carets!  is_const=True is_static=False is_vararg=False
    #shaped_text_get_carets! : RID, I32 -> Dictionary
    #shaped_text_get_carets! = Host.shaped_text_get_carets_1574219346!
    # shaped_text_get_selection!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_draw!  is_const=True is_static=False is_vararg=False
    #shaped_text_draw! : RID, RID, Vector2, F32, F32, Color, F32 -> {}
    #shaped_text_draw! = Host.shaped_text_draw_1647687596!
    # shaped_text_draw_outline!  is_const=True is_static=False is_vararg=False
    ...
    # shaped_text_get_dominant_direction_in_range!  is_const=True is_static=False is_vararg=False
    ...
    # percent_sign!  is_const=True is_static=False is_vararg=False
    #percent_sign! : String -> String
    #percent_sign! = Host.percent_sign_993269549!
    # string_get_word_breaks!  is_const=True is_static=False is_vararg=False
    #string_get_word_breaks! : String, String, I32 -> PackedInt32Array
    #string_get_word_breaks! = Host.string_get_word_breaks_581857818!
    # string_get_character_breaks!  is_const=True is_static=False is_vararg=False
    ...
    # is_confusable!  is_const=True is_static=False is_vararg=False
    #is_confusable! : String, PackedStringArray -> I32
    #is_confusable! = Host.is_confusable_1433197768!
    # spoof_check!  is_const=True is_static=False is_vararg=False
    #spoof_check! : String -> Bool
    #spoof_check! = Host.spoof_check_3927539163!
    # strip_diacritics!  is_const=True is_static=False is_vararg=False
