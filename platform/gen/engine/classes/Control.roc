...
Control := {
    ...
    SizeFlags : [SIZE_SHRINK_BEGIN, SIZE_FILL, SIZE_EXPAND, SIZE_EXPAND_FILL, SIZE_SHRINK_CENTER, SIZE_SHRINK_END]  # bitfield
    ...
    # --- methods ---
    # _has_point!  is_const=True is_static=False is_vararg=False
    #_has_point! : Vector2 -> Bool
    #_has_point! = Host._has_point_556197845!
    # _structured_text_parser!  is_const=True is_static=False is_vararg=False
    #_structured_text_parser! : Array, String -> typedarray::Vector3i
    #_structured_text_parser! = Host._structured_text_parser_1292548940!
    # _get_maximum_size!  is_const=True is_static=False is_vararg=False
    ...
    # _get_tooltip!  is_const=True is_static=False is_vararg=False
    #_get_tooltip! : Vector2 -> String
    #_get_tooltip! = Host._get_tooltip_3674420000!
    # _get_tooltip_auto_translate_mode_at!  is_const=True is_static=False is_vararg=False
    ...
    # _get_accessibility_container_name!  is_const=True is_static=False is_vararg=False
    ...
    # _gui_input!  is_const=False is_static=False is_vararg=False
    #_gui_input! : InputEvent -> {}
    #_gui_input! = Host._gui_input_3754044979!
    # accept_event!  is_const=False is_static=False is_vararg=False
    #accept_event! : () -> {}
    #accept_event! = Host.accept_event_3218959716!
    # get_maximum_size!  is_const=True is_static=False is_vararg=False
    #get_maximum_size! : () -> Vector2
    #get_maximum_size! = Host.get_maximum_size_3341600327!
    # get_combined_maximum_size!  is_const=True is_static=False is_vararg=False
    ...
    # set_anchors_and_offsets_preset!  is_const=False is_static=False is_vararg=False
    ...
    # set_anchor!  is_const=False is_static=False is_vararg=False
    #set_anchor! : enum::Side, F32, Bool, Bool -> {}
    #set_anchor! = Host.set_anchor_2302782885!
    # get_anchor!  is_const=True is_static=False is_vararg=False
    ...
    # set_anchor_and_offset!  is_const=False is_static=False is_vararg=False
    #set_anchor_and_offset! : enum::Side, F32, F32, Bool -> {}
    #set_anchor_and_offset! = Host.set_anchor_and_offset_4031722181!
    # set_begin!  is_const=False is_static=False is_vararg=False
    #set_begin! : Vector2 -> {}
    #set_begin! = Host.set_begin_743155724!
    # set_end!  is_const=False is_static=False is_vararg=False
    #set_end! : Vector2 -> {}
    ...
    # set_custom_maximum_size!  is_const=False is_static=False is_vararg=False
    #set_custom_maximum_size! : Vector2 -> {}
    #set_custom_maximum_size! = Host.set_custom_maximum_size_743155724!
    # set_custom_minimum_size!  is_const=False is_static=False is_vararg=False
    ...
    # set_pivot_offset!  is_const=False is_static=False is_vararg=False
    #set_pivot_offset! : Vector2 -> {}
    #set_pivot_offset! = Host.set_pivot_offset_743155724!
    # set_pivot_offset_ratio!  is_const=False is_static=False is_vararg=False
    #set_pivot_offset_ratio! : Vector2 -> {}
    #set_pivot_offset_ratio! = Host.set_pivot_offset_ratio_743155724!
    # get_begin!  is_const=True is_static=False is_vararg=False
    #get_begin! : () -> Vector2
    ...
    # get_screen_position!  is_const=True is_static=False is_vararg=False
    ...
    # get_global_rect!  is_const=True is_static=False is_vararg=False
    #get_global_rect! : () -> Rect2
    #get_global_rect! = Host.get_global_rect_1639390495!
    # set_focus_mode!  is_const=False is_static=False is_vararg=False
    #set_focus_mode! : enum::Control.FocusMode -> {}
    #set_focus_mode! = Host.set_focus_mode_3232914922!
    # get_focus_mode!  is_const=True is_static=False is_vararg=False
    #get_focus_mode! : () -> enum::Control.FocusMode
    #get_focus_mode! = Host.get_focus_mode_2132829277!
    # get_focus_mode_with_override!  is_const=True is_static=False is_vararg=False
    ...
    # set_focus_behavior_recursive!  is_const=False is_static=False is_vararg=False
    ...
    # get_focus_behavior_recursive!  is_const=True is_static=False is_vararg=False
    ...
    # get_offset_transform_position_ratio!  is_const=True is_static=False is_vararg=False
    ...
    # set_offset_transform_visual_only!  is_const=False is_static=False is_vararg=False
    #set_offset_transform_visual_only! : Bool -> {}
    #set_offset_transform_visual_only! = Host.set_offset_transform_visual_only_2586408642!
    # is_offset_transform_visual_only!  is_const=True is_static=False is_vararg=False
    ...
    # get_tooltip_auto_translate_mode!  is_const=True is_static=False is_vararg=False
    ...
    # set_tooltip_text!  is_const=False is_static=False is_vararg=False
    #set_tooltip_text! : String -> {}
    #set_tooltip_text! = Host.set_tooltip_text_83702148!
    # get_tooltip_text!  is_const=True is_static=False is_vararg=False
    ...
    # set_accessibility_live!  is_const=False is_static=False is_vararg=False
    ...
    # get_accessibility_live!  is_const=True is_static=False is_vararg=False
    ...
    # set_accessibility_controls_nodes!  is_const=False is_static=False is_vararg=False
    ...
    # get_accessibility_controls_nodes!  is_const=True is_static=False is_vararg=False
    ...
    # set_accessibility_described_by_nodes!  is_const=False is_static=False is_vararg=False
    ...
    # get_accessibility_described_by_nodes!  is_const=True is_static=False is_vararg=False
    ...
    # set_accessibility_labeled_by_nodes!  is_const=False is_static=False is_vararg=False
    ...
    # get_accessibility_labeled_by_nodes!  is_const=True is_static=False is_vararg=False
    ...
    # set_accessibility_flow_to_nodes!  is_const=False is_static=False is_vararg=False
    ...
    # get_accessibility_flow_to_nodes!  is_const=True is_static=False is_vararg=False
    ...
    # set_mouse_filter!  is_const=False is_static=False is_vararg=False
    #set_mouse_filter! : enum::Control.MouseFilter -> {}
    #set_mouse_filter! = Host.set_mouse_filter_3891156122!
    # get_mouse_filter!  is_const=True is_static=False is_vararg=False
    #get_mouse_filter! : () -> enum::Control.MouseFilter
    #get_mouse_filter! = Host.get_mouse_filter_1572545674!
    # get_mouse_filter_with_override!  is_const=True is_static=False is_vararg=False
    ...
    # set_mouse_behavior_recursive!  is_const=False is_static=False is_vararg=False
    ...
    # get_mouse_behavior_recursive!  is_const=True is_static=False is_vararg=False
    ...
    # set_shortcut_context!  is_const=False is_static=False is_vararg=False
    #set_shortcut_context! : Node -> {}
    #set_shortcut_context! = Host.set_shortcut_context_1078189570!
    # get_shortcut_context!  is_const=True is_static=False is_vararg=False
    #get_shortcut_context! : () -> Node
    #get_shortcut_context! = Host.get_shortcut_context_3160264692!
    # update_maximum_size!  is_const=False is_static=False is_vararg=False
    #update_maximum_size! : () -> {}
    #update_maximum_size! = Host.update_maximum_size_3218959716!
    # update_minimum_size!  is_const=False is_static=False is_vararg=False
    #update_minimum_size! : () -> {}
    ...
    # set_localize_numeral_system!  is_const=False is_static=False is_vararg=False
    #set_localize_numeral_system! : Bool -> {}
    #set_localize_numeral_system! = Host.set_localize_numeral_system_2586408642!
    # is_localizing_numeral_system!  is_const=True is_static=False is_vararg=False
