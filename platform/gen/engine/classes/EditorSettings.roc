# engine class EditorSettings → EditorSettings
# api_type: editor
...
EditorSettings := {
    ...
    # remove_shortcut!  is_const=False is_static=False is_vararg=False
    #remove_shortcut! : String -> {}
    #remove_shortcut! = Host.remove_shortcut_83702148!
    # is_shortcut!  is_const=True is_static=False is_vararg=False
    #is_shortcut! : String, InputEvent -> Bool
    #is_shortcut! = Host.is_shortcut_699917945!
    # has_shortcut!  is_const=True is_static=False is_vararg=False
    ...
    # get_shortcut_list!  is_const=False is_static=False is_vararg=False
    ...
    # mark_setting_changed!  is_const=False is_static=False is_vararg=False
