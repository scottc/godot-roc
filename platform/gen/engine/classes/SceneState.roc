# engine class SceneState → SceneState
# api_type: core
...
SceneState := {
    ...
    # get_base_scene_state!  is_const=True is_static=False is_vararg=False
    ...
    # get_node_type!  is_const=True is_static=False is_vararg=False
