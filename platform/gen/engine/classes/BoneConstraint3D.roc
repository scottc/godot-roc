# engine class BoneConstraint3D → BoneConstraint3D
# api_type: core
...
BoneConstraint3D := {
    ...
    # set_reference_bone!  is_const=False is_static=False is_vararg=False
    ...
    # set_reference_node!  is_const=False is_static=False is_vararg=False
    #set_reference_node! : I32, NodePath -> {}
    #set_reference_node! = Host.set_reference_node_2761262315!
    # get_reference_node!  is_const=True is_static=False is_vararg=False
    ...
    # clear_setting!  is_const=False is_static=False is_vararg=False
    #clear_setting! : () -> {}
