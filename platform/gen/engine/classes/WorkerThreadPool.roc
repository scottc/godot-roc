# engine class WorkerThreadPool → WorkerThreadPool
# api_type: core
...
WorkerThreadPool := {
    ...
    # wait_for_group_task_completion!  is_const=False is_static=False is_vararg=False
    #wait_for_group_task_completion! : I32 -> {}
    #wait_for_group_task_completion! = Host.wait_for_group_task_completion_1286410249!
    # get_caller_group_id!  is_const=True is_static=False is_vararg=False
