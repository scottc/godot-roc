# engine class CharacterBody2D → CharacterBody2D
# api_type: core
...
CharacterBody2D := {
    ...
    #get_up_direction! = Host.get_up_direction_3341600327!
    # set_up_direction!  is_const=False is_static=False is_vararg=False
    #set_up_direction! : Vector2 -> {}
    #set_up_direction! = Host.set_up_direction_743155724!
    # set_motion_mode!  is_const=False is_static=False is_vararg=False
    #set_motion_mode! : enum::CharacterBody2D.MotionMode -> {}
    #set_motion_mode! = Host.set_motion_mode_1224392233!
    # get_motion_mode!  is_const=True is_static=False is_vararg=False
    #get_motion_mode! : () -> enum::CharacterBody2D.MotionMode
    #get_motion_mode! = Host.get_motion_mode_1160151236!
    # set_platform_on_leave!  is_const=False is_static=False is_vararg=False
    #set_platform_on_leave! : enum::CharacterBody2D.PlatformOnLeave -> {}
    #set_platform_on_leave! = Host.set_platform_on_leave_2423324375!
    # get_platform_on_leave!  is_const=True is_static=False is_vararg=False
    #get_platform_on_leave! : () -> enum::CharacterBody2D.PlatformOnLeave
    #get_platform_on_leave! = Host.get_platform_on_leave_4054324341!
    ...
    #get_slide_collision! = Host.get_slide_collision_860659811!
    # get_last_slide_collision!  is_const=False is_static=False is_vararg=False
    #get_last_slide_collision! : () -> KinematicCollision2D
    #get_last_slide_collision! = Host.get_last_slide_collision_2161834755!
