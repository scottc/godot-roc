# engine class ImporterMeshInstance3D → ImporterMeshInstance3D
# api_type: core
...
ImporterMeshInstance3D := {
    ...
    #get_mesh! = Host.get_mesh_3161779525!
    ...
    # get_skeleton_path!  is_const=True is_static=False is_vararg=False
    #get_skeleton_path! : () -> NodePath
    #get_skeleton_path! = Host.get_skeleton_path_4075236667!
