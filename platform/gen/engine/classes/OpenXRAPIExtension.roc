# engine class OpenXRAPIExtension → OpenXRAPIExtension
# api_type: core
...
OpenXRAPIExtension := {
    ...
    # --- methods ---
    # get_openxr_version!  is_const=False is_static=False is_vararg=False
    #get_openxr_version! : () -> I32
    #get_openxr_version! = Host.get_openxr_version_2455072627!
    # get_instance!  is_const=False is_static=False is_vararg=False
    #get_instance! : () -> I32
    #get_instance! = Host.get_instance_2455072627!
    # get_system_id!  is_const=False is_static=False is_vararg=False
    #get_system_id! : () -> I32
    ...
    # get_view_configuration!  is_const=True is_static=False is_vararg=False
    #get_view_configuration! : () -> I32
    #get_view_configuration! = Host.get_view_configuration_3905245786!
    # is_initialized!  is_const=False is_static=False is_vararg=False
    #is_initialized! : () -> Bool
    ...
    # set_custom_play_space!  is_const=False is_static=False is_vararg=False
    #set_custom_play_space! : const void* -> {}
    #set_custom_play_space! = Host.set_custom_play_space_1286410249!
    # get_play_space!  is_const=False is_static=False is_vararg=False
    #get_play_space! : () -> I32
    #get_play_space! = Host.get_play_space_2455072627!
    # get_predicted_display_time!  is_const=False is_static=False is_vararg=False
    #get_predicted_display_time! : () -> I32
    #get_predicted_display_time! = Host.get_predicted_display_time_2455072627!
    # get_next_frame_time!  is_const=False is_static=False is_vararg=False
    #get_next_frame_time! : () -> I32
    #get_next_frame_time! = Host.get_next_frame_time_2455072627!
    # can_render!  is_const=False is_static=False is_vararg=False
    #can_render! : () -> Bool
    #can_render! = Host.can_render_2240911060!
    # find_action!  is_const=False is_static=False is_vararg=False
    #find_action! : String, RID -> RID
    #find_action! = Host.find_action_4106179378!
    # action_get_handle!  is_const=False is_static=False is_vararg=False
    #action_get_handle! : RID -> I32
    #action_get_handle! = Host.action_get_handle_3917799429!
    # get_hand_tracker!  is_const=False is_static=False is_vararg=False
    #get_hand_tracker! : I32 -> I32
    #get_hand_tracker! = Host.get_hand_tracker_3744713108!
    # register_composition_layer_provider!  is_const=False is_static=False is_vararg=False
    ...
    # unregister_composition_layer_provider!  is_const=False is_static=False is_vararg=False
    ...
    # register_projection_views_extension!  is_const=False is_static=False is_vararg=False
    ...
    # unregister_projection_views_extension!  is_const=False is_static=False is_vararg=False
    ...
    # register_frame_info_extension!  is_const=False is_static=False is_vararg=False
    ...
    # unregister_frame_info_extension!  is_const=False is_static=False is_vararg=False
    ...
    # register_projection_layer_extension!  is_const=False is_static=False is_vararg=False
    ...
    # unregister_projection_layer_extension!  is_const=False is_static=False is_vararg=False
    ...
    # is_environment_blend_mode_alpha_supported!  is_const=False is_static=False is_vararg=False
    ...
    # update_main_swapchain_size!  is_const=False is_static=False is_vararg=False
