# engine class DirAccess → DirAccess
# api_type: core
...
DirAccess := {
    ...
    # list_dir_begin!  is_const=False is_static=False is_vararg=False
    #list_dir_begin! : () -> enum::Error
    #list_dir_begin! = Host.list_dir_begin_166280745!
    # get_next!  is_const=False is_static=False is_vararg=False
    #get_next! : () -> String
    #get_next! = Host.get_next_2841200299!
    # current_is_dir!  is_const=True is_static=False is_vararg=False
    #current_is_dir! : () -> Bool
    #current_is_dir! = Host.current_is_dir_36873697!
    # list_dir_end!  is_const=False is_static=False is_vararg=False
    #list_dir_end! : () -> {}
    ...
    # make_dir!  is_const=False is_static=False is_vararg=False
    #make_dir! : String -> enum::Error
    #make_dir! = Host.make_dir_166001499!
    # make_dir_absolute!  is_const=False is_static=True is_vararg=False
    #make_dir_absolute! : String -> enum::Error
    #make_dir_absolute! = Host.make_dir_absolute_166001499!
    # make_dir_recursive!  is_const=False is_static=False is_vararg=False
    #make_dir_recursive! : String -> enum::Error
    #make_dir_recursive! = Host.make_dir_recursive_166001499!
    # make_dir_recursive_absolute!  is_const=False is_static=True is_vararg=False
    ...
    # dir_exists!  is_const=False is_static=False is_vararg=False
    #dir_exists! : String -> Bool
    #dir_exists! = Host.dir_exists_2323990056!
    # dir_exists_absolute!  is_const=False is_static=True is_vararg=False
    #dir_exists_absolute! : String -> Bool
    #dir_exists_absolute! = Host.dir_exists_absolute_2323990056!
    # get_space_left!  is_const=False is_static=False is_vararg=False
    #get_space_left! : () -> I32
    ...
    # copy_absolute!  is_const=False is_static=True is_vararg=False
