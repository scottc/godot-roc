...
UPNP := {
    ...
    # --- methods ---
    # get_device_count!  is_const=True is_static=False is_vararg=False
    ...
    # add_device!  is_const=False is_static=False is_vararg=False
    ...
    # remove_device!  is_const=False is_static=False is_vararg=False
    #remove_device! : I32 -> {}
    #remove_device! = Host.remove_device_1286410249!
    # clear_devices!  is_const=False is_static=False is_vararg=False
    #clear_devices! : () -> {}
    #clear_devices! = Host.clear_devices_3218959716!
    # get_gateway!  is_const=True is_static=False is_vararg=False
    #get_gateway! : () -> UPNPDevice
    #get_gateway! = Host.get_gateway_2276800779!
    # discover!  is_const=False is_static=False is_vararg=False
