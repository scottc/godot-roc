# engine class FoldableContainer → FoldableContainer
# api_type: core
...
FoldableContainer := {
    ...
    # --- methods ---
    # fold!  is_const=False is_static=False is_vararg=False
    #fold! : () -> {}
    #fold! = Host.fold_3218959716!
    # expand!  is_const=False is_static=False is_vararg=False
    #expand! : () -> {}
    #expand! = Host.expand_3218959716!
    # set_folded!  is_const=False is_static=False is_vararg=False
    #set_folded! : Bool -> {}
    #set_folded! = Host.set_folded_2586408642!
    # is_folded!  is_const=True is_static=False is_vararg=False
    #is_folded! : () -> Bool
    #is_folded! = Host.is_folded_36873697!
    # set_foldable_group!  is_const=False is_static=False is_vararg=False
    #set_foldable_group! : FoldableGroup -> {}
    #set_foldable_group! = Host.set_foldable_group_3001390597!
    # get_foldable_group!  is_const=True is_static=False is_vararg=False
    ...
    # set_title_alignment!  is_const=False is_static=False is_vararg=False
    #set_title_alignment! : enum::HorizontalAlignment -> {}
    #set_title_alignment! = Host.set_title_alignment_2312603777!
    # get_title_alignment!  is_const=True is_static=False is_vararg=False
    ...
    # get_title_text_overrun_behavior!  is_const=True is_static=False is_vararg=False
