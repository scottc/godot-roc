...
IP := {
    ...
    # --- methods ---
    # resolve_hostname!  is_const=False is_static=False is_vararg=False
    #resolve_hostname! : String, enum::IP.Type -> String
    #resolve_hostname! = Host.resolve_hostname_4283295457!
    # resolve_hostname_addresses!  is_const=False is_static=False is_vararg=False
    ...
    # resolve_hostname_queue_item!  is_const=False is_static=False is_vararg=False
