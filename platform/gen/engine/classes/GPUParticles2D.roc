# engine class GPUParticles2D → GPUParticles2D
# api_type: core
...
GPUParticles2D := {
    ...
    # set_visibility_rect!  is_const=False is_static=False is_vararg=False
    ...
    # get_visibility_rect!  is_const=True is_static=False is_vararg=False
    ...
    # capture_rect!  is_const=True is_static=False is_vararg=False
    #capture_rect! : () -> Rect2
    ...
    # set_trail_sections!  is_const=False is_static=False is_vararg=False
    #set_trail_sections! : I32 -> {}
    #set_trail_sections! = Host.set_trail_sections_1286410249!
    # get_trail_sections!  is_const=True is_static=False is_vararg=False
    #get_trail_sections! : () -> I32
    #get_trail_sections! = Host.get_trail_sections_3905245786!
    # set_trail_section_subdivisions!  is_const=False is_static=False is_vararg=False
    #set_trail_section_subdivisions! : I32 -> {}
    #set_trail_section_subdivisions! = Host.set_trail_section_subdivisions_1286410249!
    # get_trail_section_subdivisions!  is_const=True is_static=False is_vararg=False
