# engine class LookAtModifier3D → LookAtModifier3D
# api_type: core
...
LookAtModifier3D := {
    ...
    # get_primary_positive_damp_threshold!  is_const=True is_static=False is_vararg=False
    ...
    # set_primary_negative_limit_angle!  is_const=False is_static=False is_vararg=False
    #set_primary_negative_limit_angle! : F32 -> {}
    #set_primary_negative_limit_angle! = Host.set_primary_negative_limit_angle_373806689!
    # get_primary_negative_limit_angle!  is_const=True is_static=False is_vararg=False
    #get_primary_negative_limit_angle! : () -> F32
    #get_primary_negative_limit_angle! = Host.get_primary_negative_limit_angle_1740695150!
    # set_primary_negative_damp_threshold!  is_const=False is_static=False is_vararg=False
    ...
    # get_primary_negative_damp_threshold!  is_const=True is_static=False is_vararg=False
    ...
    # get_secondary_positive_limit_angle!  is_const=True is_static=False is_vararg=False
    ...
    # set_secondary_positive_damp_threshold!  is_const=False is_static=False is_vararg=False
    ...
    # get_secondary_positive_damp_threshold!  is_const=True is_static=False is_vararg=False
    ...
    # set_secondary_negative_limit_angle!  is_const=False is_static=False is_vararg=False
    ...
    # get_secondary_negative_limit_angle!  is_const=True is_static=False is_vararg=False
    ...
    # set_secondary_negative_damp_threshold!  is_const=False is_static=False is_vararg=False
    ...
    # get_secondary_negative_damp_threshold!  is_const=True is_static=False is_vararg=False
    ...
    # get_interpolation_remaining!  is_const=True is_static=False is_vararg=False
    #get_interpolation_remaining! : () -> F32
    #get_interpolation_remaining! = Host.get_interpolation_remaining_1740695150!
    # is_interpolating!  is_const=True is_static=False is_vararg=False
    #is_interpolating! : () -> Bool
    #is_interpolating! = Host.is_interpolating_36873697!
    # is_target_within_limitation!  is_const=True is_static=False is_vararg=False
