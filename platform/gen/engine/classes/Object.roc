...
Object := {
    ...
    # --- enums ---
    ConnectFlags : [CONNECT_DEFERRED, CONNECT_PERSIST, CONNECT_ONE_SHOT, CONNECT_REFERENCE_COUNTED, CONNECT_APPEND_SOURCE_OBJECT]  # bitfield

    # --- properties ---


    # --- methods ---
    # get_class!  is_const=True is_static=False is_vararg=False
    #get_class! : () -> String
    #get_class! = Host.get_class_201670096!
    # is_class!  is_const=True is_static=False is_vararg=False
    ...
    # get_incoming_connections!  is_const=True is_static=False is_vararg=False
