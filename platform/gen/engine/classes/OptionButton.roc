# engine class OptionButton → OptionButton
# api_type: core
...
OptionButton := {
    ...
    # get_selected_id!  is_const=True is_static=False is_vararg=False
    #get_selected_id! : () -> I32
    #get_selected_id! = Host.get_selected_id_3905245786!
    # get_selected_metadata!  is_const=True is_static=False is_vararg=False
    ...
    # has_selectable_items!  is_const=True is_static=False is_vararg=False
    #has_selectable_items! : () -> Bool
    #has_selectable_items! = Host.has_selectable_items_36873697!
    # get_selectable_item!  is_const=True is_static=False is_vararg=False
    #get_selectable_item! : Bool -> I32
    #get_selectable_item! = Host.get_selectable_item_894402480!
    # set_fit_to_longest_item!  is_const=False is_static=False is_vararg=False
    #set_fit_to_longest_item! : Bool -> {}
    #set_fit_to_longest_item! = Host.set_fit_to_longest_item_2586408642!
    # is_fit_to_longest_item!  is_const=True is_static=False is_vararg=False
