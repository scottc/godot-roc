# engine class AnimationMixer → AnimationMixer
# api_type: core
...
AnimationMixer := {
    ...
    # --- methods ---
    # _post_process_key_value!  is_const=True is_static=False is_vararg=False
    ...
    # set_root_node!  is_const=False is_static=False is_vararg=False
    #set_root_node! : NodePath -> {}
    #set_root_node! = Host.set_root_node_1348162250!
    # get_root_node!  is_const=True is_static=False is_vararg=False
    #get_root_node! : () -> NodePath
    #get_root_node! = Host.get_root_node_4075236667!
    # set_callback_mode_process!  is_const=False is_static=False is_vararg=False
    ...
    # get_callback_mode_process!  is_const=True is_static=False is_vararg=False
    ...
    # set_callback_mode_method!  is_const=False is_static=False is_vararg=False
    ...
    # get_callback_mode_method!  is_const=True is_static=False is_vararg=False
    ...
    # set_callback_mode_discrete!  is_const=False is_static=False is_vararg=False
    ...
    # get_callback_mode_discrete!  is_const=True is_static=False is_vararg=False
    ...
    # get_root_motion_rotation_accumulator!  is_const=True is_static=False is_vararg=False
    ...
    # get_root_motion_scale_accumulator!  is_const=True is_static=False is_vararg=False
    ...
    # clear_caches!  is_const=False is_static=False is_vararg=False
    #clear_caches! : () -> {}
