# engine class TextEdit → TextEdit
# api_type: core
...
TextEdit := {
    ...
    # --- methods ---
    # _handle_unicode_input!  is_const=False is_static=False is_vararg=False
    #_handle_unicode_input! : I32, I32 -> {}
    #_handle_unicode_input! = Host._handle_unicode_input_3937882851!
    # _backspace!  is_const=False is_static=False is_vararg=False
    #_backspace! : I32 -> {}
    #_backspace! = Host._backspace_1286410249!
    # _cut!  is_const=False is_static=False is_vararg=False
    #_cut! : I32 -> {}
    #_cut! = Host._cut_1286410249!
    # _copy!  is_const=False is_static=False is_vararg=False
    #_copy! : I32 -> {}
    #_copy! = Host._copy_1286410249!
    # _paste!  is_const=False is_static=False is_vararg=False
    #_paste! : I32 -> {}
    #_paste! = Host._paste_1286410249!
    # _paste_primary_clipboard!  is_const=False is_static=False is_vararg=False
    ...
    # set_empty_selection_clipboard_enabled!  is_const=False is_static=False is_vararg=False
    ...
    # is_empty_selection_clipboard_enabled!  is_const=True is_static=False is_vararg=False
    ...
    # set_line!  is_const=False is_static=False is_vararg=False
    #set_line! : I32, String -> {}
    #set_line! = Host.set_line_501894301!
    # get_line!  is_const=True is_static=False is_vararg=False
    #get_line! : I32 -> String
    #get_line! = Host.get_line_844755477!
    # get_line_with_ime!  is_const=True is_static=False is_vararg=False
    ...
    # get_indent_level!  is_const=True is_static=False is_vararg=False
    #get_indent_level! : I32 -> I32
    #get_indent_level! = Host.get_indent_level_923996154!
    # get_first_non_whitespace_column!  is_const=True is_static=False is_vararg=False
    #get_first_non_whitespace_column! : I32 -> I32
    #get_first_non_whitespace_column! = Host.get_first_non_whitespace_column_923996154!
    # swap_lines!  is_const=False is_static=False is_vararg=False
    #swap_lines! : I32, I32 -> {}
    #swap_lines! = Host.swap_lines_3937882851!
    # insert_line_at!  is_const=False is_static=False is_vararg=False
    #insert_line_at! : I32, String -> {}
    #insert_line_at! = Host.insert_line_at_501894301!
    # remove_line_at!  is_const=False is_static=False is_vararg=False
    ...
    # insert_text!  is_const=False is_static=False is_vararg=False
    #insert_text! : String, I32, I32, Bool, Bool -> {}
    #insert_text! = Host.insert_text_1881564334!
    # remove_text!  is_const=False is_static=False is_vararg=False
    #remove_text! : I32, I32, I32, I32 -> {}
    #remove_text! = Host.remove_text_4275841770!
    # get_last_unhidden_line!  is_const=True is_static=False is_vararg=False
    #get_last_unhidden_line! : () -> I32
    #get_last_unhidden_line! = Host.get_last_unhidden_line_3905245786!
    # get_next_visible_line_offset_from!  is_const=True is_static=False is_vararg=False
    ...
    # get_next_visible_line_index_offset_from!  is_const=True is_static=False is_vararg=False
    ...
    # backspace!  is_const=False is_static=False is_vararg=False
    #backspace! : I32 -> {}
    #backspace! = Host.backspace_1025054187!
    # cut!  is_const=False is_static=False is_vararg=False
    #cut! : I32 -> {}
    #cut! = Host.cut_1025054187!
    # copy!  is_const=False is_static=False is_vararg=False
    #copy! : I32 -> {}
    #copy! = Host.copy_1025054187!
    # paste!  is_const=False is_static=False is_vararg=False
    #paste! : I32 -> {}
    #paste! = Host.paste_1025054187!
    # paste_primary_clipboard!  is_const=False is_static=False is_vararg=False
    #paste_primary_clipboard! : I32 -> {}
    #paste_primary_clipboard! = Host.paste_primary_clipboard_1025054187!
    # start_action!  is_const=False is_static=False is_vararg=False
    #start_action! : enum::TextEdit.EditAction -> {}
    #start_action! = Host.start_action_2834827583!
    # end_action!  is_const=False is_static=False is_vararg=False
    #end_action! : () -> {}
    #end_action! = Host.end_action_3218959716!
    # begin_complex_operation!  is_const=False is_static=False is_vararg=False
    #begin_complex_operation! : () -> {}
    #begin_complex_operation! = Host.begin_complex_operation_3218959716!
    # end_complex_operation!  is_const=False is_static=False is_vararg=False
    ...
    # clear_undo_history!  is_const=False is_static=False is_vararg=False
    #clear_undo_history! : () -> {}
    #clear_undo_history! = Host.clear_undo_history_3218959716!
    # tag_saved_version!  is_const=False is_static=False is_vararg=False
    #tag_saved_version! : () -> {}
    ...
    # get_saved_version!  is_const=True is_static=False is_vararg=False
    #get_saved_version! : () -> I32
    #get_saved_version! = Host.get_saved_version_3905245786!
    # set_search_text!  is_const=False is_static=False is_vararg=False
    #set_search_text! : String -> {}
    #set_search_text! = Host.set_search_text_83702148!
    # set_search_flags!  is_const=False is_static=False is_vararg=False
    ...
    # set_draw_caret_when_editable_disabled!  is_const=False is_static=False is_vararg=False
    ...
    # is_drawing_caret_when_editable_disabled!  is_const=True is_static=False is_vararg=False
    ...
    # set_move_caret_on_right_click_enabled!  is_const=False is_static=False is_vararg=False
    ...
    # is_move_caret_on_right_click_enabled!  is_const=True is_static=False is_vararg=False
    ...
    # get_caret_wrap_index!  is_const=True is_static=False is_vararg=False
    #get_caret_wrap_index! : I32 -> I32
    #get_caret_wrap_index! = Host.get_caret_wrap_index_1591665591!
    # get_word_under_caret!  is_const=True is_static=False is_vararg=False
    #get_word_under_caret! : I32 -> String
    #get_word_under_caret! = Host.get_word_under_caret_3929349208!
    # set_use_default_word_separators!  is_const=False is_static=False is_vararg=False
    #set_use_default_word_separators! : Bool -> {}
    #set_use_default_word_separators! = Host.set_use_default_word_separators_2586408642!
    # is_default_word_separators_enabled!  is_const=True is_static=False is_vararg=False
    ...
    # set_selection_mode!  is_const=False is_static=False is_vararg=False
    #set_selection_mode! : enum::TextEdit.SelectionMode -> {}
    #set_selection_mode! = Host.set_selection_mode_1658801786!
    # get_selection_mode!  is_const=True is_static=False is_vararg=False
    ...
    # select_word_under_caret!  is_const=False is_static=False is_vararg=False
    #select_word_under_caret! : I32 -> {}
    #select_word_under_caret! = Host.select_word_under_caret_1025054187!
    # add_selection_for_next_occurrence!  is_const=False is_static=False is_vararg=False
    #add_selection_for_next_occurrence! : () -> {}
    #add_selection_for_next_occurrence! = Host.add_selection_for_next_occurrence_3218959716!
    # skip_selection_for_next_occurrence!  is_const=False is_static=False is_vararg=False
    ...
    # get_selection_at_line_column!  is_const=True is_static=False is_vararg=False
    ...
    # get_line_ranges_from_carets!  is_const=True is_static=False is_vararg=False
    ...
    # get_selection_to_line!  is_const=True is_static=False is_vararg=False
    ...
    # is_caret_after_selection_origin!  is_const=True is_static=False is_vararg=False
    ...
    # delete_selection!  is_const=False is_static=False is_vararg=False
    #delete_selection! : I32 -> {}
    #delete_selection! = Host.delete_selection_1025054187!
    # set_line_wrapping_mode!  is_const=False is_static=False is_vararg=False
    #set_line_wrapping_mode! : enum::TextEdit.LineWrappingMode -> {}
    #set_line_wrapping_mode! = Host.set_line_wrapping_mode_2525115309!
    # get_line_wrapping_mode!  is_const=True is_static=False is_vararg=False
    ...
    # set_scroll_past_end_of_file_enabled!  is_const=False is_static=False is_vararg=False
    ...
    # is_scroll_past_end_of_file_enabled!  is_const=True is_static=False is_vararg=False
    ...
    # get_visible_line_count_in_range!  is_const=True is_static=False is_vararg=False
    ...
    # set_draw_tabs!  is_const=False is_static=False is_vararg=False
    #set_draw_tabs! : Bool -> {}
    #set_draw_tabs! = Host.set_draw_tabs_2586408642!
    # is_drawing_tabs!  is_const=True is_static=False is_vararg=False
    #is_drawing_tabs! : () -> Bool
    #is_drawing_tabs! = Host.is_drawing_tabs_36873697!
    # set_draw_spaces!  is_const=False is_static=False is_vararg=False
    #set_draw_spaces! : Bool -> {}
    #set_draw_spaces! = Host.set_draw_spaces_2586408642!
    # is_drawing_spaces!  is_const=True is_static=False is_vararg=False
