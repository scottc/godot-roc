...
Input := {
    ...
    # is_action_just_pressed!  is_const=True is_static=False is_vararg=False
    #is_action_just_pressed! : StringName, Bool -> Bool
    #is_action_just_pressed! = Host.is_action_just_pressed_1558498928!
    # is_action_just_released!  is_const=True is_static=False is_vararg=False
    #is_action_just_released! : StringName, Bool -> Bool
    #is_action_just_released! = Host.is_action_just_released_1558498928!
    # is_action_just_pressed_by_event!  is_const=True is_static=False is_vararg=False
    ...
    # is_action_just_released_by_event!  is_const=True is_static=False is_vararg=False
    ...
    # get_action_raw_strength!  is_const=True is_static=False is_vararg=False
    ...
    # is_joy_vibrating!  is_const=False is_static=False is_vararg=False
    #is_joy_vibrating! : I32 -> Bool
    #is_joy_vibrating! = Host.is_joy_vibrating_3067735520!
    # has_joy_vibration!  is_const=True is_static=False is_vararg=False
    #has_joy_vibration! : I32 -> Bool
    #has_joy_vibration! = Host.has_joy_vibration_1116898809!
    # start_joy_vibration!  is_const=False is_static=False is_vararg=False
    #start_joy_vibration! : I32, F32, F32, F32 -> {}
    #start_joy_vibration! = Host.start_joy_vibration_2576575033!
    # stop_joy_vibration!  is_const=False is_static=False is_vararg=False
    #stop_joy_vibration! : I32 -> {}
    #stop_joy_vibration! = Host.stop_joy_vibration_1286410249!
    # vibrate_handheld!  is_const=False is_static=False is_vararg=False
    #vibrate_handheld! : I32, F32 -> {}
    #vibrate_handheld! = Host.vibrate_handheld_544894297!
    # set_ignore_joypad_on_unfocused_application!  is_const=False is_static=False is_vararg=False
    ...
    # is_ignoring_joypad_on_unfocused_application!  is_const=True is_static=False is_vararg=False
    ...
    # stop_joy_motion_sensors_calibration!  is_const=False is_static=False is_vararg=False
    ...
    # clear_joy_motion_sensors_calibration!  is_const=False is_static=False is_vararg=False
    ...
    # get_joy_motion_sensors_calibration!  is_const=True is_static=False is_vararg=False
    ...
    # set_joy_motion_sensors_calibration!  is_const=False is_static=False is_vararg=False
    ...
    # is_joy_motion_sensors_calibrated!  is_const=True is_static=False is_vararg=False
    ...
    # is_joy_motion_sensors_calibrating!  is_const=True is_static=False is_vararg=False
    ...
    # action_press!  is_const=False is_static=False is_vararg=False
    #action_press! : StringName, F32 -> {}
    #action_press! = Host.action_press_1713091165!
    # action_release!  is_const=False is_static=False is_vararg=False
    ...
    # get_current_cursor_shape!  is_const=True is_static=False is_vararg=False
    #get_current_cursor_shape! : () -> enum::Input.CursorShape
    #get_current_cursor_shape! = Host.get_current_cursor_shape_3455658929!
    # set_custom_mouse_cursor!  is_const=False is_static=False is_vararg=False
