# engine class NavigationAgent3D → NavigationAgent3D
# api_type: core
...
NavigationAgent3D := {
    ...
    # set_path_height_offset!  is_const=False is_static=False is_vararg=False
    #set_path_height_offset! : F32 -> {}
    #set_path_height_offset! = Host.set_path_height_offset_373806689!
    # get_path_height_offset!  is_const=True is_static=False is_vararg=False
    ...
    # set_keep_y_velocity!  is_const=False is_static=False is_vararg=False
    #set_keep_y_velocity! : Bool -> {}
    #set_keep_y_velocity! = Host.set_keep_y_velocity_2586408642!
    # get_keep_y_velocity!  is_const=True is_static=False is_vararg=False
