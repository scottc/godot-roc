# engine class CPUParticles2D → CPUParticles2D
# api_type: core
...
CPUParticles2D := {
    ...
    # property emission_points : PackedVector2Array
    #   getter: get_emission_points
    #   setter: set_emission_points
    # property emission_normals : PackedVector2Array
    ...
    #set_draw_order! : enum::CPUParticles2D.DrawOrder -> {}
    #set_draw_order! = Host.set_draw_order_4183193490!
    # get_draw_order!  is_const=True is_static=False is_vararg=False
    #get_draw_order! : () -> enum::CPUParticles2D.DrawOrder
    #get_draw_order! = Host.get_draw_order_1668655735!
    ...
    #set_direction! = Host.set_direction_743155724!
    # get_direction!  is_const=True is_static=False is_vararg=False
    #get_direction! : () -> Vector2
    #get_direction! = Host.get_direction_3341600327!
    ...
    #set_param_min! : enum::CPUParticles2D.Parameter, F32 -> {}
    #set_param_min! = Host.set_param_min_3320615296!
    # get_param_min!  is_const=True is_static=False is_vararg=False
    #get_param_min! : enum::CPUParticles2D.Parameter -> F32
    #get_param_min! = Host.get_param_min_2038050600!
    # set_param_max!  is_const=False is_static=False is_vararg=False
    #set_param_max! : enum::CPUParticles2D.Parameter, F32 -> {}
    #set_param_max! = Host.set_param_max_3320615296!
    # get_param_max!  is_const=True is_static=False is_vararg=False
    #get_param_max! : enum::CPUParticles2D.Parameter -> F32
    #get_param_max! = Host.get_param_max_2038050600!
    # set_param_curve!  is_const=False is_static=False is_vararg=False
    #set_param_curve! : enum::CPUParticles2D.Parameter, Curve -> {}
    #set_param_curve! = Host.set_param_curve_2959350143!
    # get_param_curve!  is_const=True is_static=False is_vararg=False
    #get_param_curve! : enum::CPUParticles2D.Parameter -> Curve
    #get_param_curve! = Host.get_param_curve_2603158474!
    ...
    #set_particle_flag! : enum::CPUParticles2D.ParticleFlags, Bool -> {}
    #set_particle_flag! = Host.set_particle_flag_4178137949!
    # get_particle_flag!  is_const=True is_static=False is_vararg=False
    #get_particle_flag! : enum::CPUParticles2D.ParticleFlags -> Bool
    #get_particle_flag! = Host.get_particle_flag_2829976507!
    # set_emission_shape!  is_const=False is_static=False is_vararg=False
    #set_emission_shape! : enum::CPUParticles2D.EmissionShape -> {}
    #set_emission_shape! = Host.set_emission_shape_393763892!
    # get_emission_shape!  is_const=True is_static=False is_vararg=False
    #get_emission_shape! : () -> enum::CPUParticles2D.EmissionShape
    #get_emission_shape! = Host.get_emission_shape_1740246024!
    ...
    # set_emission_rect_extents!  is_const=False is_static=False is_vararg=False
    #set_emission_rect_extents! : Vector2 -> {}
    #set_emission_rect_extents! = Host.set_emission_rect_extents_743155724!
    # get_emission_rect_extents!  is_const=True is_static=False is_vararg=False
    #get_emission_rect_extents! : () -> Vector2
    #get_emission_rect_extents! = Host.get_emission_rect_extents_3341600327!
    # set_emission_points!  is_const=False is_static=False is_vararg=False
    #set_emission_points! : PackedVector2Array -> {}
    #set_emission_points! = Host.set_emission_points_1509147220!
    # get_emission_points!  is_const=True is_static=False is_vararg=False
    #get_emission_points! : () -> PackedVector2Array
    #get_emission_points! = Host.get_emission_points_2961356807!
    # set_emission_normals!  is_const=False is_static=False is_vararg=False
    #set_emission_normals! : PackedVector2Array -> {}
    #set_emission_normals! = Host.set_emission_normals_1509147220!
    # get_emission_normals!  is_const=True is_static=False is_vararg=False
    #get_emission_normals! : () -> PackedVector2Array
    #get_emission_normals! = Host.get_emission_normals_2961356807!
