# engine class OpenXRExtensionWrapper → OpenXRExtensionWrapper
# api_type: core
...
OpenXRExtensionWrapper := {
    ...
    # --- methods ---
    # _get_requested_extensions!  is_const=False is_static=False is_vararg=False
    #_get_requested_extensions! : I32 -> Dictionary
    #_get_requested_extensions! = Host._get_requested_extensions_3554694381!
    # _set_system_properties_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_instance_create_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_session_create_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_swapchain_create_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_hand_joint_locations_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_projection_views_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_frame_wait_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_frame_end_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_projection_layer_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_view_locate_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _set_reference_space_create_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _prepare_view_configuration!  is_const=False is_static=False is_vararg=False
    #_prepare_view_configuration! : I32 -> {}
    #_prepare_view_configuration! = Host._prepare_view_configuration_1286410249!
    # _set_view_configuration_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # _get_viewport_composition_layer_extension_properties!  is_const=False is_static=False is_vararg=False
    ...
    # _get_viewport_composition_layer_extension_property_defaults!  is_const=False is_static=False is_vararg=False
    ...
    # _on_viewport_composition_layer_destroyed!  is_const=False is_static=False is_vararg=False
    ...
    # _set_android_surface_swapchain_create_info_and_get_next_pointer!  is_const=False is_static=False is_vararg=False
    ...
    # get_openxr_api!  is_const=False is_static=False is_vararg=False
    #get_openxr_api! : () -> OpenXRAPIExtension
    #get_openxr_api! = Host.get_openxr_api_1637791613!
    # register_extension_wrapper!  is_const=False is_static=False is_vararg=False
