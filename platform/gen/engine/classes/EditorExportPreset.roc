# engine class EditorExportPreset → EditorExportPreset
# api_type: editor
...
EditorExportPreset := {
    ...
    # get_or_env!  is_const=True is_static=False is_vararg=False
