# engine class VisualShaderNodeVec4Parameter → VisualShaderNodeVec4Parameter
# api_type: core
...
VisualShaderNodeVec4Parameter := {
    ...
    #set_default_value! = Host.set_default_value_643568085!
    # get_default_value!  is_const=True is_static=False is_vararg=False
    #get_default_value! : () -> Vector4
    #get_default_value! = Host.get_default_value_2435802345!
