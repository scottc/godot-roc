# engine class XRInterfaceExtension → XRInterfaceExtension
# api_type: core
...
XRInterfaceExtension := {
    ...
    # _get_capabilities!  is_const=True is_static=False is_vararg=False
    #_get_capabilities! : () -> I32
    #_get_capabilities! = Host._get_capabilities_3905245786!
    # _is_initialized!  is_const=True is_static=False is_vararg=False
    ...
    # _uninitialize!  is_const=False is_static=False is_vararg=False
    #_uninitialize! : () -> {}
    #_uninitialize! = Host._uninitialize_3218959716!
    # _get_system_info!  is_const=True is_static=False is_vararg=False
    #_get_system_info! : () -> Dictionary
    #_get_system_info! = Host._get_system_info_3102165223!
    # _supports_play_area_mode!  is_const=True is_static=False is_vararg=False
    ...
    # _get_vrs_texture!  is_const=False is_static=False is_vararg=False
    #_get_vrs_texture! : () -> RID
    #_get_vrs_texture! = Host._get_vrs_texture_529393457!
    # _get_vrs_texture_format!  is_const=False is_static=False is_vararg=False
    ...
    # _pre_render!  is_const=False is_static=False is_vararg=False
    #_pre_render! : () -> {}
    #_pre_render! = Host._pre_render_3218959716!
    # _pre_draw_viewport!  is_const=False is_static=False is_vararg=False
    #_pre_draw_viewport! : RID -> Bool
    #_pre_draw_viewport! = Host._pre_draw_viewport_3521089500!
    # _post_draw_viewport!  is_const=False is_static=False is_vararg=False
    #_post_draw_viewport! : RID, Rect2 -> {}
    #_post_draw_viewport! = Host._post_draw_viewport_1378122625!
    # _end_frame!  is_const=False is_static=False is_vararg=False
    #_end_frame! : () -> {}
    #_end_frame! = Host._end_frame_3218959716!
    # _get_suggested_tracker_names!  is_const=True is_static=False is_vararg=False
    #_get_suggested_tracker_names! : () -> PackedStringArray
    #_get_suggested_tracker_names! = Host._get_suggested_tracker_names_1139954409!
    # _get_suggested_pose_names!  is_const=True is_static=False is_vararg=False
    ...
    # add_blit!  is_const=False is_static=False is_vararg=False
    #add_blit! : RID, Rect2, Rect2i, Bool, I32, Bool, Vector2, F32, F32, F32, F32 -> {}
    #add_blit! = Host.add_blit_258596971!
    # get_render_target_texture!  is_const=False is_static=False is_vararg=False
