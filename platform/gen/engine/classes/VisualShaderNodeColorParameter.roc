# engine class VisualShaderNodeColorParameter → VisualShaderNodeColorParameter
# api_type: core
...
VisualShaderNodeColorParameter := {
    ...
    #set_default_value! = Host.set_default_value_2920490490!
    # get_default_value!  is_const=True is_static=False is_vararg=False
    #get_default_value! : () -> Color
    #get_default_value! = Host.get_default_value_3444240500!
