...
TileMap := {
    ...
    # --- methods ---
    # _use_tile_data_runtime_update!  is_const=False is_static=False is_vararg=False
    ...
    # _tile_data_runtime_update!  is_const=False is_static=False is_vararg=False
    ...
    # set_navigation_visibility_mode!  is_const=False is_static=False is_vararg=False
    ...
    # get_navigation_visibility_mode!  is_const=True is_static=False is_vararg=False
    ...
    # erase_cell!  is_const=False is_static=False is_vararg=False
    ...
    # map_pattern!  is_const=False is_static=False is_vararg=False
    #map_pattern! : Vector2i, Vector2i, TileMapPattern -> Vector2i
    #map_pattern! = Host.map_pattern_1864516957!
    # set_pattern!  is_const=False is_static=False is_vararg=False
    #set_pattern! : I32, Vector2i, TileMapPattern -> {}
    #set_pattern! = Host.set_pattern_1195853946!
    # set_cells_terrain_connect!  is_const=False is_static=False is_vararg=False
    ...
    # get_used_cells_by_id!  is_const=True is_static=False is_vararg=False
    ...
    # get_neighbor_cell!  is_const=True is_static=False is_vararg=False
