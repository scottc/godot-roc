# engine class CollisionObject3D → CollisionObject3D
# api_type: core
...
CollisionObject3D := {
    ...
    # set_capture_input_on_drag!  is_const=False is_static=False is_vararg=False
    #set_capture_input_on_drag! : Bool -> {}
    #set_capture_input_on_drag! = Host.set_capture_input_on_drag_2586408642!
    # get_capture_input_on_drag!  is_const=True is_static=False is_vararg=False
