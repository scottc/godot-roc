# engine class NativeMenu → NativeMenu
# api_type: core
...
NativeMenu := {
    ...
    # has_system_menu!  is_const=True is_static=False is_vararg=False
    ...
    # find_item_index_with_text!  is_const=True is_static=False is_vararg=False
    #find_item_index_with_text! : RID, String -> I32
    #find_item_index_with_text! = Host.find_item_index_with_text_1362438794!
    # find_item_index_with_tag!  is_const=True is_static=False is_vararg=False
    #find_item_index_with_tag! : RID, Variant -> I32
    #find_item_index_with_tag! = Host.find_item_index_with_tag_1260085030!
    # find_item_index_with_submenu!  is_const=True is_static=False is_vararg=False
    ...
    # get_item_callback!  is_const=True is_static=False is_vararg=False
    #get_item_callback! : RID, I32 -> Callable
    #get_item_callback! = Host.get_item_callback_1639989698!
    # get_item_key_callback!  is_const=True is_static=False is_vararg=False
    #get_item_key_callback! : RID, I32 -> Callable
    #get_item_key_callback! = Host.get_item_key_callback_1639989698!
    # get_item_tag!  is_const=True is_static=False is_vararg=False
    ...
    # is_item_hidden!  is_const=True is_static=False is_vararg=False
    ...
    # get_item_state!  is_const=True is_static=False is_vararg=False
    #get_item_state! : RID, I32 -> I32
    #get_item_state! = Host.get_item_state_1120910005!
    # get_item_max_states!  is_const=True is_static=False is_vararg=False
    ...
    # get_item_indentation_level!  is_const=True is_static=False is_vararg=False
    ...
    # set_item_hidden!  is_const=False is_static=False is_vararg=False
    ...
    # set_item_state!  is_const=False is_static=False is_vararg=False
    #set_item_state! : RID, I32, I32 -> {}
    #set_item_state! = Host.set_item_state_4288446313!
    # set_item_max_states!  is_const=False is_static=False is_vararg=False
    ...
    # set_item_indentation_level!  is_const=False is_static=False is_vararg=False
