# engine class TextParagraph → TextParagraph
# api_type: core
...
TextParagraph := {
    ...
    # get_inferred_direction!  is_const=True is_static=False is_vararg=False
    #get_inferred_direction! : () -> enum::TextServer.Direction
    #get_inferred_direction! = Host.get_inferred_direction_2516697328!
    # set_custom_punctuation!  is_const=False is_static=False is_vararg=False
    #set_custom_punctuation! : String -> {}
    #set_custom_punctuation! = Host.set_custom_punctuation_83702148!
    # get_custom_punctuation!  is_const=True is_static=False is_vararg=False
    ...
    # tab_align!  is_const=False is_static=False is_vararg=False
    #tab_align! : PackedFloat32Array -> {}
    #tab_align! = Host.tab_align_2899603908!
    # set_break_flags!  is_const=False is_static=False is_vararg=False
    #set_break_flags! : bitfield::TextServer.LineBreakFlag -> {}
    #set_break_flags! = Host.set_break_flags_2809697122!
    # get_break_flags!  is_const=True is_static=False is_vararg=False
    ...
    # get_non_wrapped_size!  is_const=True is_static=False is_vararg=False
    ...
    # get_line_rid!  is_const=True is_static=False is_vararg=False
    #get_line_rid! : I32 -> RID
    #get_line_rid! = Host.get_line_rid_495598643!
    # get_dropcap_rid!  is_const=True is_static=False is_vararg=False
    #get_dropcap_rid! : () -> RID
