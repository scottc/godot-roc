...
main! = |_args| {
    ...
    Stdout.line!(
        ...
        \\# Builtin Classes
        \\#
        \\${render_builtin_classes(decoded)}
        \\
    )?
...
render_builtin_classes : ExtensionApi -> Str
render_builtin_classes = |eapi| {
    eapi.builtin_classes.fold("", |a, b| "${a}${builtin_class_to_roc_source_str(b)}\n")
}
